...
class HXCPP_CLASS_ATTRIBUTES FlxObject_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		void drawDebugBoundingBox( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int allowCollisions,bool partial);
		::Dynamic drawDebugBoundingBox_dyn();

		 ::openfl::display::Graphics beginDrawDebug( ::flixel::FlxCamera camera);

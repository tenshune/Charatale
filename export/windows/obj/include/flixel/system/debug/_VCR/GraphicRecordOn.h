...
class HXCPP_CLASS_ATTRIBUTES GraphicRecordOn_obj : public  ::openfl::display::BitmapData_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< GraphicRecordOn_obj > __alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA);
		...
		::String __ToString() const { return HX_("GraphicRecordOn",b8,48,80,85); }

...
class HXCPP_CLASS_ATTRIBUTES FlxDebugger_obj : public  ::openfl::display::Sprite_obj
{
	...
	public:
		...
		::Dynamic resetButtonLayout_dyn();
		 ...
		 ::flixel::_hx_system::ui::FlxSystemButton addButton( ::flixel::util::FlxHorizontalAlign Position, ::openfl::display::BitmapData Icon, ::Dynamic UpHandler,::hx::Null< bool >  ToggleMode,::hx::Null< bool >  UpdateLayout);

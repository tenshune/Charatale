...
class HXCPP_CLASS_ATTRIBUTES FlxButtonEvent_obj : public ::hx::Object
{
	...
	public:
		...
		static ::hx::ObjectPtr< FlxButtonEvent_obj > __new( ::Dynamic Callback, ::flixel::sound::FlxSound sound);
		static ::hx::ObjectPtr< FlxButtonEvent_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic Callback, ::flixel::sound::FlxSound sound);

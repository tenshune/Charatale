...
HX_DECLARE_STACK_FRAME(_hx_pos_15168aeef7c4c51a_22_new)
...
HXLINE(  23)		( ( ::flixel::graphics::frames::bmfont::BMFontKerning)(__this) )->first = first;
HXLINE(  24)		( ( ::flixel::graphics::frames::bmfont::BMFontKerning)(__this) )->second = second;
HXLINE(  25)		( ( ::flixel::graphics::frames::bmfont::BMFontKerning)(__this) )->amount = amount;
            	}

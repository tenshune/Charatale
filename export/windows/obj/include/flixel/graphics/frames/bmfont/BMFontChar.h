...
HX_DECLARE_STACK_FRAME(_hx_pos_89999802178ac74a_18_new)
...
HXLINE(  30)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->letter = null();
HXLINE(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->id = id;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->x = x;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->y = y;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->width = width;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->height = height;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->xoffset = xoffset;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->yoffset = yoffset;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->xadvance = xadvance;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->page = page;
HXDLIN(  18)		( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->chnl = chnl;
HXDLIN(  18)		if (::hx::IsNotNull( letter )) {
HXDLIN(  18)			( ( ::flixel::graphics::frames::bmfont::BMFontChar)(__this) )->letter = letter;
            		}
            	}

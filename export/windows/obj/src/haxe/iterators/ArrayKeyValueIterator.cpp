...
HX_LOCAL_STACK_FRAME(_hx_pos_5868e9ee7f4b28b2_37_hasNext,"haxe.iterators.ArrayKeyValueIterator","hasNext",0x73cdeb47,"haxe.iterators.ArrayKeyValueIterator.hasNext","C:\\HaxeToolkit\\haxe\\std/haxe/iterators/ArrayKeyValueIterator.hx",37,0x982cc1ff)
HX_LOCAL_STACK_FRAME(_hx_pos_5868e9ee7f4b28b2_42_next,"haxe.iterators.ArrayKeyValueIterator","next",0xf1b472d9,"haxe.iterators.ArrayKeyValueIterator.next","C:\\HaxeToolkit\\haxe\\std/haxe/iterators/ArrayKeyValueIterator.hx",42,0x982cc1ff)
namespace haxe{
namespace iterators{
...
bool ArrayKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_5868e9ee7f4b28b2_37_hasNext)
HXDLIN(  37)		return (this->current < this->array->get_length());
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ArrayKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic ArrayKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_5868e9ee7f4b28b2_42_next)
HXDLIN(  42)		 ::Dynamic _hx_tmp = this->array->__get(this->current);
HXDLIN(  42)		return  ::Dynamic(::hx::Anon_obj::Create(2)

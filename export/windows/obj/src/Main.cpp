...
HXLINE(  11)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,0,0,::flixel::util::typeLimit::_NextState::InitialState_Impl__obj::fromType(::hx::ClassOf< ::mapStates::theRuins::Zone3 >()),null(),null(),null(),null()));
            	}

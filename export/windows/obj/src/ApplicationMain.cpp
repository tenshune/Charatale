...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("chocolateDummy",0c,7f,2b,b0),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("35",a2,2c,00,00));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Angelfoxiano",27,15,9b,1a));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("chocolateDummy",0c,7f,2b,b0));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Charatale",51,f7,d2,ee));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Charatale",51,f7,d2,ee))
...
HXDLIN( 162)					 ::Dynamic e = ::haxe::Exception_obj::caught(_g)->unwrap();

...
HX_LOCAL_STACK_FRAME(_hx_pos_5f7463bd5b510fa4_404_canSwitchTo,"flixel.FlxG","canSwitchTo",0x84b804d8,"flixel.FlxG.canSwitchTo","flixel/FlxG.hx",404,0x8e176836)
...
bool FlxG_obj::canSwitchTo( ::flixel::FlxState nextState){
            	HX_STACKFRAME(&_hx_pos_5f7463bd5b510fa4_404_canSwitchTo)
HXDLIN( 404)		 ::flixel::FlxState _hx_tmp = ::flixel::FlxG_obj::game->_state;
HXDLIN( 404)		return ( (bool)(::Reflect_obj::callMethod(_hx_tmp,::Reflect_obj::field(::flixel::FlxG_obj::game->_state,HX_("switchTo",8f,f8,d6,0d)),::cpp::VirtualArray_obj::__new(1)->init(0,nextState))) );
            	}
...
HXLINE( 419)					_hx_tmp = ::flixel::FlxG_obj::canSwitchTo(( ( ::flixel::FlxState)(nextState) ));
            				}
            				else {
...
HXLINE( 422)				 ::Dynamic nextState = ::flixel::util::typeLimit::_NextState::NextState_Impl__obj::fromState(( ( ::flixel::FlxState)(::Type_obj::createInstance(::Type_obj::getClass(::flixel::FlxG_obj::game->_state),::cpp::VirtualArray_obj::__new(0))) ));
HXDLIN( 422)				 ::flixel::FlxState stateOnCall = ::flixel::FlxG_obj::game->_state;
HXDLIN( 422)				bool _hx_tmp;
HXDLIN( 422)				if (::Std_obj::isOfType(nextState,::hx::ClassOf< ::flixel::FlxState >())) {
HXLINE( 422)					_hx_tmp = ::flixel::FlxG_obj::canSwitchTo(( ( ::flixel::FlxState)(nextState) ));
            				}
            				else {
...
HXLINE( 422)						if (::hx::IsInstanceEq( ::flixel::FlxG_obj::game->_state,stateOnCall )) {
HXLINE( 422)							::flixel::FlxG_obj::game->_nextState = nextState;
            						}
            						else {
...
HXLINE( 422)					::flixel::FlxG_obj::game->_state->startOutro( ::Dynamic(new _hx_Closure_1(nextState,stateOnCall)));
            				}
            			}
            		}
            	}
...
HXDLIN( 109)		VERSION =  ::flixel::_hx_system::FlxVersion_obj::__alloc( HX_CTX ,5,6,0);
            	}
{

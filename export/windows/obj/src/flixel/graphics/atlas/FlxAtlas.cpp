...
HXLINE( 183)			HX_STACK_DO_THROW(HX_("addNode can't find the key for specified BitmapData. Please provide not null value as a Key argument.",d2,94,28,ae));
            		}
...
HXLINE( 196)			HX_STACK_DO_THROW(((HX_("addNode can't find BitmapData with specified key: ",7b,9b,ce,f1) + Graphic) + HX_(". Please provide valid value.",84,e6,88,32)));
            		}
...
HXLINE( 380)				::String _hx_tmp2 = ((((((((((((HX_("Can't insert node ",5a,c7,4d,53) + key) + HX_(" with the size of (",b5,20,c2,55)) + data->width) + HX_("; ",85,33,00,00)) + data->height) + HX_(") in atlas ",99,70,14,d3)) + this->name) + HX_(" with the max size of (",b9,b3,66,74)) + this->maxWidth) + HX_("; ",85,33,00,00)) + this->maxHeight) + HX_(") and powerOfTwo: ",d6,69,4d,94));
HXDLIN( 380)				HX_STACK_DO_THROW((_hx_tmp2 + ::Std_obj::string(this->powerOfTwo)));
            			}
...
HXLINE( 463)				::String _hx_tmp11 = ((((((((((((HX_("Can't insert node ",5a,c7,4d,53) + key) + HX_(" with the size of (",b5,20,c2,55)) + data->width) + HX_("; ",85,33,00,00)) + data->height) + HX_(") in atlas ",99,70,14,d3)) + this->name) + HX_(" with the max size of (",b9,b3,66,74)) + this->maxWidth) + HX_("; ",85,33,00,00)) + this->maxHeight) + HX_(") and powerOfTwo: ",d6,69,4d,94));
HXDLIN( 463)				HX_STACK_DO_THROW((_hx_tmp11 + ::Std_obj::string(this->powerOfTwo)));
            			}
...
HXLINE( 481)			bool _hx_tmp12;
HXDLIN( 481)			bool _hx_tmp13;
HXDLIN( 481)			bool _hx_tmp14;
HXDLIN( 481)			if (canExpandRight) {
HXLINE( 481)				_hx_tmp14 = canExpandRightRotate;
            			}
            			else {
HXLINE( 481)				_hx_tmp14 = false;
            			}
HXDLIN( 481)			if (_hx_tmp14) {
HXLINE( 481)				_hx_tmp13 = (addRightArea > addRightAreaRotate);
            			}
            			else {
...
HXLINE( 481)					_hx_tmp12 = canExpandRightRotate;
            				}
            				else {
...
HXLINE( 490)			bool _hx_tmp15;
HXDLIN( 490)			bool _hx_tmp16;
HXDLIN( 490)			bool _hx_tmp17;
HXDLIN( 490)			if (canExpandBottom) {
HXLINE( 490)				_hx_tmp17 = canExpandBottomRotate;
            			}
            			else {
HXLINE( 490)				_hx_tmp17 = false;
            			}
HXDLIN( 490)			if (_hx_tmp17) {
HXLINE( 490)				_hx_tmp16 = (addBottomArea > addBottomAreaRotate);
            			}
            			else {
...
HXLINE( 490)					_hx_tmp15 = canExpandBottomRotate;
            				}
            				else {
...
HXLINE( 500)			bool _hx_tmp18;
HXDLIN( 500)			if (!(canExpandRight)) {
HXLINE( 500)				_hx_tmp18 = canExpandBottom;
            			}
            			else {
HXLINE( 500)				_hx_tmp18 = false;
            			}
HXDLIN( 500)			if (_hx_tmp18) {
HXLINE( 502)				addRightArea = (addBottomArea + 1);
HXLINE( 503)				rotateNode = rotateRight;
            			}
            			else {
HXLINE( 505)				bool _hx_tmp19;
HXDLIN( 505)				if (canExpandRight) {
HXLINE( 505)					_hx_tmp19 = !(canExpandBottom);
            				}
            				else {
HXLINE( 505)					_hx_tmp19 = false;
            				}
HXDLIN( 505)				if (_hx_tmp19) {
...
HXLINE( 525)				int _hx_tmp20 = (::Std_obj::_hx_int(temp->rect->width) + insertNodeWidth);
HXDLIN( 525)				this->expandRoot(( (Float)(_hx_tmp20) ),::Math_obj::max(( (Float)(::Std_obj::_hx_int(temp->rect->height)) ),( (Float)(insertNodeHeight) )),true,null());
...
HXLINE( 537)				Float _hx_tmp21 = ::Math_obj::max(( (Float)(::Std_obj::_hx_int(temp->rect->width)) ),( (Float)(insertNodeWidth) ));
HXDLIN( 537)				this->expandRoot(_hx_tmp21,( (Float)((::Std_obj::_hx_int(temp->rect->height) + insertNodeHeight)) ),false,null());
...
HXLINE( 613)			HX_STACK_DO_THROW((HX_("addNodeWithSpacings can't find the key for specified BitmapData.",41,5c,a7,0a) + HX_(" Please provide not null value as a Key argument.",09,c1,63,d1)));
            		}
...
HXLINE( 628)			HX_STACK_DO_THROW(((HX_("addNodeWithSpacings can't find BitmapData with specified key: ",e5,6a,ec,e9) + Graphic) + HX_(". Please provide valid value.",84,e6,88,32)));
            		}
...
HXLINE( 639)			HX_STACK_DO_THROW(((HX_("addNodeWithSpacings can't insert provided image: ",a1,49,3a,35) + Graphic) + HX_(") in atlas. It's probably too big.",a7,39,69,92)));
            		}
...
HXLINE( 728)			HX_STACK_DO_THROW(((((HX_("The number of bitmaps (",cb,e8,a2,a6) + numBitmaps) + HX_(") should be equal to number of keys (",a0,90,37,97)) + numKeys) + HX_(")",29,00,00,00)));
            		}
...
HXLINE(1096)					HX_STACK_DO_THROW((HX_("Can't set powerOfTwo property to true,",95,3e,d2,3d) + HX_(" since it requires to increase atlas size which is bigger that max size",8f,79,d1,e8)));
            				}

...
HXLINE( 506)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
...
HXLINE( 510)			 ::flixel::math::FlxBasePoint _this = this->tileSize;
...
HXLINE( 511)			 ::flixel::math::FlxBasePoint _this = this->tileSpacing;
...
HXLINE( 512)			 ::flixel::math::FlxBasePoint _this = this->border;
...
HXLINE( 201)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 201)		point->_inPool = false;
HXDLIN( 201)		 ::flixel::math::FlxBasePoint this1 = point;
...
HXLINE( 202)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN( 202)		point1->_inPool = false;
HXDLIN( 202)		tileFrames->tileSpacing = point1;
...
HXLINE( 211)					tileFrames->framesByName->set(frame->name,frame);
            				}
            			}
            		}
...
HXDLIN( 305)						 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXDLIN( 443)						 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
...
HXDLIN( 443)						 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(tileWidth,tileHeight);
HXDLIN( 443)						point->_inPool = false;
HXDLIN( 443)						 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN( 443)						point1->_inPool = false;
HXDLIN( 443)						result->addAtlasFrame(rect,point,point1,null(),null(),null(),null(),null());

...
HX_DEFINE_STACK_FRAME(_hx_pos_15168aeef7c4c51a_22_new,"flixel.graphics.frames.bmfont.BMFontKerning","new",0x3f14a8c7,"flixel.graphics.frames.bmfont.BMFontKerning.new","flixel/graphics/frames/bmfont/BMFontKerning.hx",22,0x2251be89)
HX_LOCAL_STACK_FRAME(_hx_pos_15168aeef7c4c51a_30_fromXml,"flixel.graphics.frames.bmfont.BMFontKerning","fromXml",0xd258d674,"flixel.graphics.frames.bmfont.BMFontKerning.fromXml","flixel/graphics/frames/bmfont/BMFontKerning.hx",30,0x2251be89)
HX_LOCAL_STACK_FRAME(_hx_pos_15168aeef7c4c51a_39_listFromXml,"flixel.graphics.frames.bmfont.BMFontKerning","listFromXml",0x9d7fc936,"flixel.graphics.frames.bmfont.BMFontKerning.listFromXml","flixel/graphics/frames/bmfont/BMFontKerning.hx",39,0x2251be89)
HX_LOCAL_STACK_FRAME(_hx_pos_15168aeef7c4c51a_52_fromText,"flixel.graphics.frames.bmfont.BMFontKerning","fromText",0x38b7ed70,"flixel.graphics.frames.bmfont.BMFontKerning.fromText","flixel/graphics/frames/bmfont/BMFontKerning.hx",52,0x2251be89)
HX_LOCAL_STACK_FRAME(_hx_pos_15168aeef7c4c51a_45_fromText,"flixel.graphics.frames.bmfont.BMFontKerning","fromText",0x38b7ed70,"flixel.graphics.frames.bmfont.BMFontKerning.fromText","flixel/graphics/frames/bmfont/BMFontKerning.hx",45,0x2251be89)
...
HX_LOCAL_STACK_FRAME(_hx_pos_15168aeef7c4c51a_65_listFromBytes,"flixel.graphics.frames.bmfont.BMFontKerning","listFromBytes",0x3111398a,"flixel.graphics.frames.bmfont.BMFontKerning.listFromBytes","flixel/graphics/frames/bmfont/BMFontKerning.hx",65,0x2251be89)
namespace flixel{
namespace graphics{
namespace frames{
namespace bmfont{
...
void BMFontKerning_obj::__construct(::hx::Null< int >  __o_first,::hx::Null< int >  __o_second,::hx::Null< int >  __o_amount){
            	...
            	HX_STACKFRAME(&_hx_pos_15168aeef7c4c51a_22_new)
HXLINE(  23)		this->first = first;
HXLINE(  24)		this->second = second;
...
bool BMFontKerning_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::bmfont::BMFontKerning BMFontKerning_obj::fromXml( ::Xml kerningNode){
            	HX_GC_STACKFRAME(&_hx_pos_15168aeef7c4c51a_30_fromXml)
HXLINE(  32)		 ::Dynamic _g = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(kerningNode,HX_("first",30,78,9d,00)));
HXLINE(  33)		 ::Dynamic _g1 = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(kerningNode,HX_("second",74,cf,47,64)));
HXLINE(  31)		return  ::flixel::graphics::frames::bmfont::BMFontKerning_obj::__alloc( HX_CTX ,_g,_g1,::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(kerningNode,HX_("amount",d8,11,03,d5))));
            	}
...
::Array< ::Dynamic> BMFontKerning_obj::listFromXml( ::Xml kerningsNode){
            	HX_STACKFRAME(&_hx_pos_15168aeef7c4c51a_39_listFromXml)
HXLINE(  40)		::Array< ::Dynamic> kernings = ::haxe::xml::_Access::NodeListAccess_Impl__obj::resolve(kerningsNode,HX_("kerning",cc,ba,37,b0));
HXLINE(  41)		::Array< ::Dynamic> _g = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(  41)		{
HXLINE(  41)			int _g1 = 0;
HXDLIN(  41)			while((_g1 < kernings->length)){
HXLINE(  41)				 ::Xml pair = kernings->__get(_g1).StaticCast<  ::Xml >();
HXDLIN(  41)				_g1 = (_g1 + 1);
HXDLIN(  41)				_g->push(::flixel::graphics::frames::bmfont::BMFontKerning_obj::fromXml(pair));
            			}
            		}
HXDLIN(  41)		return _g;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BMFontKerning_obj,listFromXml,return )
 ...
 ::flixel::graphics::frames::bmfont::BMFontKerning BMFontKerning_obj::fromText(::String kerningText){
            		...
            		void _hx_run(::String key,::String value){
            			HX_STACKFRAME(&_hx_pos_15168aeef7c4c51a_52_fromText)
HXLINE(  52)			::String _hx_switch_0 = key;
            			if (  (_hx_switch_0==HX_("amount",d8,11,03,d5)) ){
HXLINE(  56)				amount[0] = ( (int)(::Std_obj::parseInt(value)) );
HXDLIN(  56)				goto _hx_goto_4;
            			}
            			if (  (_hx_switch_0==HX_("first",30,78,9d,00)) ){
HXLINE(  54)				first[0] = ( (int)(::Std_obj::parseInt(value)) );
HXDLIN(  54)				goto _hx_goto_4;
            			}
            			if (  (_hx_switch_0==HX_("second",74,cf,47,64)) ){
HXLINE(  55)				second[0] = ( (int)(::Std_obj::parseInt(value)) );
HXDLIN(  55)				goto _hx_goto_4;
            	...
            	HX_GC_STACKFRAME(&_hx_pos_15168aeef7c4c51a_45_fromText)
HXLINE(  46)		::Array< int > first = ::Array_obj< int >::fromData( _hx_array_data_87b93955_7,1);
HXLINE(  47)		::Array< int > second = ::Array_obj< int >::fromData( _hx_array_data_87b93955_8,1);
HXLINE(  48)		::Array< int > amount = ::Array_obj< int >::fromData( _hx_array_data_87b93955_9,1);
HXLINE(  49)		::flixel::graphics::frames::bmfont::BMFontUtil_obj::forEachAttribute(kerningText, ::Dynamic(new _hx_Closure_0(second,amount,first)));
HXLINE(  61)		return  ::flixel::graphics::frames::bmfont::BMFontKerning_obj::__alloc( HX_CTX ,first->__get(0),second->__get(0),amount->__get(0));
            	}
...
::Array< ::Dynamic> BMFontKerning_obj::listFromBytes( ::haxe::io::BytesInput bytes){
            	HX_GC_STACKFRAME(&_hx_pos_15168aeef7c4c51a_65_listFromBytes)
HXLINE(  66)		int blockSize = bytes->readInt32();
HXLINE(  67)		::Array< ::Dynamic> kernings = ::Array_obj< ::Dynamic>::__new();
HXLINE(  68)		while((blockSize > 0)){
HXLINE(  72)			int _g = bytes->readInt32();
HXLINE(  73)			int _g1 = bytes->readInt32();
HXLINE(  70)			 ::flixel::graphics::frames::bmfont::BMFontKerning kerning =  ::flixel::graphics::frames::bmfont::BMFontKerning_obj::__alloc( HX_CTX ,_g,_g1,bytes->readInt16());
HXLINE(  76)			kernings->push(kerning);
HXLINE(  77)			blockSize = (blockSize - 10);
            		}
HXLINE(  79)		return kernings;
            	}

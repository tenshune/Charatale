...
HX_DEFINE_STACK_FRAME(_hx_pos_548404df940b75d5_15_new,"flixel.graphics.frames.bmfont.BMFontCommon","new",0x6b9304b4,"flixel.graphics.frames.bmfont.BMFontCommon.new","flixel/graphics/frames/bmfont/BMFontCommon.hx",15,0x09925b3c)
HX_LOCAL_STACK_FRAME(_hx_pos_548404df940b75d5_30_fromXml,"flixel.graphics.frames.bmfont.BMFontCommon","fromXml",0x02982ce1,"flixel.graphics.frames.bmfont.BMFontCommon.fromXml","flixel/graphics/frames/bmfont/BMFontCommon.hx",30,0x09925b3c)
HX_LOCAL_STACK_FRAME(_hx_pos_548404df940b75d5_61_fromText,"flixel.graphics.frames.bmfont.BMFontCommon","fromText",0x3fe43663,"flixel.graphics.frames.bmfont.BMFontCommon.fromText","flixel/graphics/frames/bmfont/BMFontCommon.hx",61,0x09925b3c)
HX_LOCAL_STACK_FRAME(_hx_pos_548404df940b75d5_46_fromText,"flixel.graphics.frames.bmfont.BMFontCommon","fromText",0x3fe43663,"flixel.graphics.frames.bmfont.BMFontCommon.fromText","flixel/graphics/frames/bmfont/BMFontCommon.hx",46,0x09925b3c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_548404df940b75d5_93_fromBytes,"flixel.graphics.frames.bmfont.BMFontCommon","fromBytes",0x57ca1df5,"flixel.graphics.frames.bmfont.BMFontCommon.fromBytes","flixel/graphics/frames/bmfont/BMFontCommon.hx",93,0x09925b3c)
namespace flixel{
namespace graphics{
namespace frames{
namespace bmfont{
...
void BMFontCommon_obj::__construct(int lineHeight,int base,int scaleW,int scaleH,int pages,bool packed,int alphaChnl,int redChnl,int greenChnl,int blueChnl){
            	HX_STACKFRAME(&_hx_pos_548404df940b75d5_15_new)
HXDLIN(  15)		this->lineHeight = lineHeight;
HXDLIN(  15)		this->base = base;
HXDLIN(  15)		this->scaleW = scaleW;
HXDLIN(  15)		this->scaleH = scaleH;
HXDLIN(  15)		this->pages = pages;
HXDLIN(  15)		this->packed = packed;
HXDLIN(  15)		this->alphaChnl = alphaChnl;
HXDLIN(  15)		this->redChnl = redChnl;
HXDLIN(  15)		this->greenChnl = greenChnl;
HXDLIN(  15)		this->blueChnl = blueChnl;
            	}
...
bool BMFontCommon_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::bmfont::BMFontCommon BMFontCommon_obj::fromXml( ::Xml commonNode){
            	HX_GC_STACKFRAME(&_hx_pos_548404df940b75d5_30_fromXml)
HXLINE(  32)		 ::Dynamic _g = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("lineHeight",fb,02,f4,d6)));
HXLINE(  33)		 ::Dynamic _g1 = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("base",11,e8,10,41)));
HXLINE(  34)		 ::Dynamic _g2 = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("scaleW",8d,ea,25,3c)));
HXLINE(  35)		 ::Dynamic _g3 = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("scaleH",7e,ea,25,3c)));
HXLINE(  36)		 ::Dynamic _g4 = ::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("pages",44,2b,4d,bd)));
HXLINE(  37)		bool _g5 = (::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("packed",78,57,98,e3)) != HX_("0",30,00,00,00));
HXLINE(  38)		int _g6;
HXDLIN(  38)		if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(commonNode,HX_("alphaChnl",a1,44,b9,db))) {
HXLINE(  38)			_g6 = ( (int)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("alphaChnl",a1,44,b9,db)))) );
            		}
            		else {
HXLINE(  38)			_g6 = 0;
            		}
HXLINE(  39)		int _g7;
HXDLIN(  39)		if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(commonNode,HX_("redChnl",14,ec,44,a7))) {
HXLINE(  39)			_g7 = ( (int)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("redChnl",14,ec,44,a7)))) );
            		}
            		else {
HXLINE(  39)			_g7 = 0;
            		}
HXLINE(  40)		int _g8;
HXDLIN(  40)		if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(commonNode,HX_("greenChnl",86,c2,47,a4))) {
HXLINE(  40)			_g8 = ( (int)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("greenChnl",86,c2,47,a4)))) );
            		}
            		else {
HXLINE(  40)			_g8 = 0;
            		}
HXLINE(  41)		int _hx_tmp;
HXDLIN(  41)		if (::haxe::xml::_Access::HasAttribAccess_Impl__obj::resolve(commonNode,HX_("blueChnl",dd,2d,30,8c))) {
HXLINE(  41)			_hx_tmp = ( (int)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(commonNode,HX_("blueChnl",dd,2d,30,8c)))) );
            		}
            		else {
HXLINE(  41)			_hx_tmp = 0;
            		}
HXLINE(  31)		return  ::flixel::graphics::frames::bmfont::BMFontCommon_obj::__alloc( HX_CTX ,( (int)(_g) ),( (int)(_g1) ),( (int)(_g2) ),( (int)(_g3) ),( (int)(_g4) ),_g5,_g6,_g7,_g8,_hx_tmp);
            	}
...
HXDLIN(  65)				goto _hx_goto_2;
            	...
            	HX_GC_STACKFRAME(&_hx_pos_548404df940b75d5_46_fromText)
HXLINE(  47)		::Array< int > lineHeight = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_5,1);
HXLINE(  48)		::Array< int > base = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_6,1);
HXLINE(  49)		::Array< int > scaleW = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_7,1);
HXLINE(  50)		::Array< int > scaleH = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_8,1);
HXLINE(  51)		::Array< int > pages = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_9,1);
HXLINE(  52)		::Array< bool > packed = ::Array_obj< bool >::fromData( _hx_array_data_c825dac2_10,1);
HXLINE(  53)		::Array< int > alphaChnl = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_11,1);
HXLINE(  54)		::Array< int > redChnl = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_12,1);
HXLINE(  55)		::Array< int > greenChnl = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_13,1);
HXLINE(  56)		::Array< int > blueChnl = ::Array_obj< int >::fromData( _hx_array_data_c825dac2_14,1);
HXLINE(  58)		::flixel::graphics::frames::bmfont::BMFontUtil_obj::forEachAttribute(commonText, ::Dynamic(new _hx_Closure_0(base,alphaChnl,scaleH,lineHeight,redChnl,blueChnl,greenChnl,scaleW,pages,packed)));
HXLINE(  77)		return  ::flixel::graphics::frames::bmfont::BMFontCommon_obj::__alloc( HX_CTX ,lineHeight->__get(0),base->__get(0),scaleW->__get(0),scaleH->__get(0),pages->__get(0),packed->__get(0),alphaChnl->__get(0),redChnl->__get(0),greenChnl->__get(0),blueChnl->__get(0));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BMFontCommon_obj,fromText,return )
 ...
 ::flixel::graphics::frames::bmfont::BMFontCommon BMFontCommon_obj::fromBytes( ::haxe::io::BytesInput bytes){
            	HX_GC_STACKFRAME(&_hx_pos_548404df940b75d5_93_fromBytes)
HXLINE(  94)		int blockSize = bytes->readInt32();
HXLINE(  95)		if ((blockSize != 15)) {
HXLINE(  96)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Invalid block size for common block. Expected 15 got ",ac,2f,ff,0a) + blockSize)));
            		}
HXLINE(  99)		int _g = bytes->readInt16();
HXLINE( 100)		int _g1 = bytes->readInt16();
HXLINE( 101)		int _g2 = bytes->readInt16();
HXLINE( 102)		int _g3 = bytes->readInt16();
HXLINE( 103)		int _g4 = bytes->readInt16();
HXLINE( 104)		bool _g5 = ((bytes->readByte() & 2) != 0);
HXLINE( 105)		int _g6 = bytes->readByte();
HXLINE( 106)		int _g7 = bytes->readByte();
HXLINE( 107)		int _g8 = bytes->readByte();
HXLINE(  98)		return  ::flixel::graphics::frames::bmfont::BMFontCommon_obj::__alloc( HX_CTX ,_g,_g1,_g2,_g3,_g4,_g5,_g6,_g7,_g8,bytes->readByte());
            	}

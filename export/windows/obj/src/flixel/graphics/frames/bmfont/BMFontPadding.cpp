...
HX_DEFINE_STACK_FRAME(_hx_pos_389f2ddd7620ccce_135_new,"flixel.graphics.frames.bmfont.BMFontPadding","new",0xfd16ae4c,"flixel.graphics.frames.bmfont.BMFontPadding.new","flixel/graphics/frames/bmfont/BMFontInfo.hx",135,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_389f2ddd7620ccce_151_fromString,"flixel.graphics.frames.bmfont.BMFontPadding","fromString",0x9af8256f,"flixel.graphics.frames.bmfont.BMFontPadding.fromString","flixel/graphics/frames/bmfont/BMFontInfo.hx",151,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_389f2ddd7620ccce_164_fromBytes,"flixel.graphics.frames.bmfont.BMFontPadding","fromBytes",0xc9b1098d,"flixel.graphics.frames.bmfont.BMFontPadding.fromBytes","flixel/graphics/frames/bmfont/BMFontInfo.hx",164,0x8997cf99)
namespace flixel{
namespace graphics{
namespace frames{
namespace bmfont{
...
HXLINE( 140)		this->left = 0;
HXLINE( 139)		this->down = 0;
HXLINE( 138)		this->right = 0;
HXLINE( 137)		this->up = 0;
HXLINE( 144)		this->up = up;
HXLINE( 145)		this->right = right;
HXLINE( 146)		this->down = down;
HXLINE( 147)		this->left = left;
            	}
...
bool BMFontPadding_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::bmfont::BMFontPadding BMFontPadding_obj::fromString(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_389f2ddd7620ccce_151_fromString)
HXLINE( 152)		::Array< ::String > values = data.split(HX_(",",2c,00,00,00));
HXLINE( 155)		 ::Dynamic _g = ::Std_obj::parseInt(values->__get(0));
HXLINE( 156)		 ::Dynamic _g1 = ::Std_obj::parseInt(values->__get(1));
HXLINE( 157)		 ::Dynamic _g2 = ::Std_obj::parseInt(values->__get(2));
HXLINE( 154)		return  ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,_g,_g1,_g2,::Std_obj::parseInt(values->__get(3)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BMFontPadding_obj,fromString,return )
 ...
 ::flixel::graphics::frames::bmfont::BMFontPadding BMFontPadding_obj::fromBytes( ::haxe::io::BytesInput bytes){
            	HX_GC_STACKFRAME(&_hx_pos_389f2ddd7620ccce_164_fromBytes)
HXLINE( 166)		int _g = bytes->readByte();
HXLINE( 167)		int _g1 = bytes->readByte();
HXLINE( 168)		int _g2 = bytes->readByte();
HXLINE( 165)		return  ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,_g,_g1,_g2,bytes->readByte());
            	}

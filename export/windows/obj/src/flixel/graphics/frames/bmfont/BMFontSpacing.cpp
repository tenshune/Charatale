...
HX_DEFINE_STACK_FRAME(_hx_pos_319c3b7c9cf620d2_175_new,"flixel.graphics.frames.bmfont.BMFontSpacing","new",0x120848fe,"flixel.graphics.frames.bmfont.BMFontSpacing.new","flixel/graphics/frames/bmfont/BMFontInfo.hx",175,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_319c3b7c9cf620d2_187_fromString,"flixel.graphics.frames.bmfont.BMFontSpacing","fromString",0x93e124fd,"flixel.graphics.frames.bmfont.BMFontSpacing.fromString","flixel/graphics/frames/bmfont/BMFontInfo.hx",187,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_319c3b7c9cf620d2_194_fromBytes,"flixel.graphics.frames.bmfont.BMFontSpacing","fromBytes",0x7cbeb5bf,"flixel.graphics.frames.bmfont.BMFontSpacing.fromBytes","flixel/graphics/frames/bmfont/BMFontInfo.hx",194,0x8997cf99)
namespace flixel{
namespace graphics{
namespace frames{
namespace bmfont{
...
bool BMFontSpacing_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::bmfont::BMFontSpacing BMFontSpacing_obj::fromString(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_319c3b7c9cf620d2_187_fromString)
HXLINE( 188)		::Array< ::String > values = data.split(HX_(",",2c,00,00,00));
HXLINE( 189)		 ::Dynamic _g = ::Std_obj::parseInt(values->__get(0));
HXDLIN( 189)		return  ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::__alloc( HX_CTX ,_g,::Std_obj::parseInt(values->__get(1)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BMFontSpacing_obj,fromString,return )
 ...
 ::flixel::graphics::frames::bmfont::BMFontSpacing BMFontSpacing_obj::fromBytes( ::haxe::io::BytesInput bytes){
            	HX_GC_STACKFRAME(&_hx_pos_319c3b7c9cf620d2_194_fromBytes)
HXDLIN( 194)		int _g = bytes->readByte();
HXDLIN( 194)		return  ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::__alloc( HX_CTX ,_g,bytes->readByte());
            	}

...
HXLINE(  90)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE(  92)			 ::openfl::display::Graphics gfx = camera->debugLayer->get_graphics();
HXLINE(  93)			gfx->lineStyle(1,-16776961,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(  94)			gfx->drawTriangles(this->vertices,this->indices,this->uvtData,null());
            		}

...
HX_DEFINE_STACK_FRAME(_hx_pos_d2197318fd890c91_533_new,"flixel.path.FlxTypedPathfinderData","new",0xf7913c76,"flixel.path.FlxTypedPathfinderData.new","flixel/path/FlxPathfinder.hx",533,0x74454158)
...
void FlxTypedPathfinderData_obj::__construct( ::Dynamic map,int startIndex,int endIndex){
            	HX_STACKFRAME(&_hx_pos_d2197318fd890c91_533_new)
HXLINE( 557)		this->numChecks = 0;
...
HXLINE( 666)		this->numChecks++;
HXLINE( 667)		 ::Dynamic _hx_tmp = this->map;
...
void FlxTypedPathfinderData_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(numChecks,"numChecks");
	HX_MARK_END_CLASS();
}
...
void FlxTypedPathfinderData_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(numChecks,"numChecks");
}
...
::hx::Val FlxTypedPathfinderData_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"numChecks") ) { return ::hx::Val( numChecks ); }
		break;
	case 10:
...
::hx::Val FlxTypedPathfinderData_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"numChecks") ) { numChecks=inValue.Cast< int >(); return inValue; }
		break;
	case 10:
...
void FlxTypedPathfinderData_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("numChecks",91,61,10,6b));
...
static ::hx::StorageInfo FlxTypedPathfinderData_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsInt,(int)offsetof(FlxTypedPathfinderData_obj,numChecks),HX_("numChecks",91,61,10,6b)},
	{ ::hx::fsUnknown, 0, null()}
};

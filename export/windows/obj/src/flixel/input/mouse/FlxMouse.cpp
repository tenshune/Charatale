...
HXLINE( 753)			 ::openfl::display::Stage _hx_tmp = this->_stage;
HXDLIN( 753)			_hx_tmp->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseUp",e0,f3,72,c0),true,false,record->x,record->y,null(),null(),null(),null(),null(),null(),null(),null(),null()));
            		}

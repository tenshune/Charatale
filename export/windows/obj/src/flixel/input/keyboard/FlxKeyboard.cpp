...
HXLINE( 100)		this->super::onKeyUp(event);
HXLINE( 104)		bool _hx_tmp;
HXDLIN( 104)		if (::hx::IsNotNull( ::flixel::FlxG_obj::game->debugger )) {
HXLINE( 104)			_hx_tmp = this->inKeyArray(::flixel::FlxG_obj::debugger->toggleKeys,event);
            		}
            		else {
HXLINE( 104)			_hx_tmp = false;
            		}
HXDLIN( 104)		if (_hx_tmp) {
HXLINE( 106)			::flixel::FlxG_obj::debugger->set_visible(!(::flixel::FlxG_obj::debugger->visible));
            		}
            	}

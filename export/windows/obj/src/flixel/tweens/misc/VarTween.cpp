...
HXLINE(  30)			HX_STACK_DO_THROW(HX_("Cannot tween variables of an object that is null.",4e,3a,13,2f));
            		}
            		else {
HXLINE(  31)			if (::hx::IsNull( properties )) {
HXLINE(  32)				HX_STACK_DO_THROW(HX_("Cannot tween null properties.",74,80,03,52));
            			}
            		}

...
HXLINE( 239)				 ::flixel::math::FlxRect _this = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 239)				_this->x = camera->x;
HXDLIN( 239)				_this->y = camera->y;
HXDLIN( 239)				_this->width = ( (Float)(camera->width) );
HXDLIN( 239)				_this->height = ( (Float)(camera->height) );
            			}
            		}

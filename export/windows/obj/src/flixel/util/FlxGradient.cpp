...
HXLINE(  56)			{
HXLINE(  56)				int _g2 = 1;
HXDLIN(  56)				int _g3 = (colors->length - 1);
HXDLIN(  56)				while((_g2 < _g3)){
HXLINE(  56)					_g2 = (_g2 + 1);
HXDLIN(  56)					int ri = (_g2 - 1);
...
HXLINE( 135)			int int3 = height;
HXDLIN( 135)			Float tempBitmap;
HXDLIN( 135)			if ((int3 < 0)) {
HXLINE( 135)				tempBitmap = (((Float)4294967296.0) + int3);
            			}
            			else {
HXLINE( 135)				tempBitmap = (int3 + ((Float)0.0));
            			}
HXDLIN( 135)			int int4 = chunkSize;
HXDLIN( 135)			Float tempBitmap1;
HXDLIN( 135)			if ((int4 < 0)) {
HXLINE( 135)				tempBitmap1 = (((Float)4294967296.0) + int4);
            			}
            			else {
HXLINE( 135)				tempBitmap1 = (int4 + ((Float)0.0));
            			}
...
HXLINE( 137)			int int5 = chunkSize;
HXDLIN( 137)			Float _hx_tmp6;
HXDLIN( 137)			if ((int5 < 0)) {
HXLINE( 137)				_hx_tmp6 = (((Float)4294967296.0) + int5);
            			}
            			else {
HXLINE( 137)				_hx_tmp6 = (int5 + ((Float)0.0));
            			}
HXDLIN( 137)			tempBitmap2->set_scaleY(_hx_tmp6);
HXLINE( 139)			 ::openfl::geom::Matrix sM =  ::openfl::geom::Matrix_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
HXLINE( 140)			Float _hx_tmp7 = tempBitmap2->get_scaleX();
HXDLIN( 140)			sM->scale(_hx_tmp7,tempBitmap2->get_scaleY());
HXLINE( 142)			data->draw(tempBitmap2,sM,null(),null(),null(),null());
HXLINE( 145)			Float remainingRect = tempBitmap2->get_height();
HXDLIN( 145)			int int6 = width;
HXDLIN( 145)			Float remainingRect1;
HXDLIN( 145)			if ((int6 < 0)) {
HXLINE( 145)				remainingRect1 = (((Float)4294967296.0) + int6);
            			}
            			else {
HXLINE( 145)				remainingRect1 = (int6 + ((Float)0.0));
            			}
HXDLIN( 145)			Float b = tempBitmap2->get_height();
HXDLIN( 145)			int int7 = height;
HXDLIN( 145)			Float remainingRect2;
HXDLIN( 145)			if ((int7 < 0)) {
HXLINE( 145)				remainingRect2 = (((Float)4294967296.0) + int7);
            			}
            			else {
HXLINE( 145)				remainingRect2 = (int7 + ((Float)0.0));
            			}
...
HXLINE( 180)		 ::flixel::FlxSprite source = ::flixel::util::FlxGradient_obj::createGradientFlxSprite(width,height,colors,chunkSize,rotation,interpolate);

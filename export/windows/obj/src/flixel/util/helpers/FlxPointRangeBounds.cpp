...
HXDLIN(  85)		if (result) {
HXLINE(  86)			 ::flixel::math::FlxBasePoint _this1 = ( ( ::flixel::math::FlxBasePoint)(this->start->max) );
HXDLIN(  86)			 ::flixel::math::FlxBasePoint point1 = ( ( ::flixel::math::FlxBasePoint)(OtherFlxPointRangeBounds->start->max) );
...
HXLINE(  87)			 ::flixel::math::FlxBasePoint _this2 = ( ( ::flixel::math::FlxBasePoint)(this->end->min) );
HXDLIN(  87)			 ::flixel::math::FlxBasePoint point2 = ( ( ::flixel::math::FlxBasePoint)(OtherFlxPointRangeBounds->end->min) );
...
HXLINE(  88)			 ::flixel::math::FlxBasePoint _this3 = ( ( ::flixel::math::FlxBasePoint)(this->end->max) );
HXDLIN(  88)			 ::flixel::math::FlxBasePoint point3 = ( ( ::flixel::math::FlxBasePoint)(OtherFlxPointRangeBounds->end->max) );

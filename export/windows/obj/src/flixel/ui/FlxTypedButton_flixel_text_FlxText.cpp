...
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_338_drawDebug,"flixel.ui.FlxTypedButton_flixel_text_FlxText","drawDebug",0xbcdf6ce4,"flixel.ui.FlxTypedButton_flixel_text_FlxText.drawDebug","flixel/ui/FlxButton.hx",338,0xc64cf442)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ffa67752db428172_505_onUpEventListener,"flixel.ui.FlxTypedButton_flixel_text_FlxText","onUpEventListener",0xcc8c5f29,"flixel.ui.FlxTypedButton_flixel_text_FlxText.onUpEventListener","flixel/ui/FlxButton.hx",505,0xc64cf442)
...
HXLINE( 149)		this->mouseButtons = ::Array_obj< int >::fromData( _hx_array_data_6ddca163_1,1);
HXLINE( 143)		this->allowSwiping = true;
HXLINE( 137)		this->statusAnimations = ::Array_obj< ::String >::fromData( _hx_array_data_6ddca163_2,3);
HXLINE( 131)		this->labelAlphas = ::Array_obj< Float >::fromData( _hx_array_data_6ddca163_3,3);
...
void FlxTypedButton_flixel_text_FlxText_obj::drawDebug(){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_338_drawDebug)
...
HXLINE( 375)				 ::flixel::text::FlxText _hx_tmp = this->label;
HXDLIN( 375)				_hx_tmp->set_frames(labelNode->getImageFrame());
            			}
            		}
...
void FlxTypedButton_flixel_text_FlxText_obj::onUpEventListener( ::openfl::events::MouseEvent _){
            	HX_STACKFRAME(&_hx_pos_ffa67752db428172_505_onUpEventListener)

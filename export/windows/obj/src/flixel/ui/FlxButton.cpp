...
HXLINE(  59)				 ::flixel::math::FlxBasePoint point = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN(  59)				_g = (_g + 1);
HXLINE(  60)				{
HXLINE(  60)					Float y = (point->y + 3);
HXDLIN(  60)					point->set_x(point->x);
HXDLIN(  60)					point->set_y(y);
            				}
            			}
            		}
HXLINE(  62)		if (::hx::IsNotNull( Text )) {
HXLINE(  62)			this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(this->x + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->x),(this->y + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->y),80,Text,null(),null()));
...
HXLINE(  83)			this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(this->x + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->x),(this->y + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->y),80,Text,null(),null()));
...
HXLINE(  99)				this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,(this->x + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->x),(this->y + this->labelOffsets->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->y),80,Text,null(),null()));

...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_219_draw,"flixel.group.FlxTypedSpriteGroup","draw",0x0c4e99b1,"flixel.group.FlxTypedSpriteGroup.draw","flixel/group/FlxSpriteGroup.hx",219,0xeb1fa7f3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1102_loadGraphicFromSprite,"flixel.group.FlxTypedSpriteGroup","loadGraphicFromSprite",0x6f12dc84,"flixel.group.FlxTypedSpriteGroup.loadGraphicFromSprite","flixel/group/FlxSpriteGroup.hx",1102,0xeb1fa7f3)
...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1125_loadRotatedGraphic,"flixel.group.FlxTypedSpriteGroup","loadRotatedGraphic",0x45e23732,"flixel.group.FlxTypedSpriteGroup.loadRotatedGraphic","flixel/group/FlxSpriteGroup.hx",1125,0xeb1fa7f3)
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_1137_makeGraphic,"flixel.group.FlxTypedSpriteGroup","makeGraphic",0x27a1d44d,"flixel.group.FlxTypedSpriteGroup.makeGraphic","flixel/group/FlxSpriteGroup.hx",1137,0xeb1fa7f3)
...
HXLINE( 653)					_hx_tmp = sprite->exists;
            				}
            				else {
...
void FlxTypedSpriteGroup_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_219_draw)
HXLINE( 220)		this->group->draw();
HXLINE( 223)		if (::flixel::FlxG_obj::debugger->drawDebug) {
HXLINE( 224)			this->drawDebug();
            		}
            	}
...
HXLINE( 736)				_hx_tmp = (this->alpha != 0);
            			}
            			else {
...
HX_DEFINE_DYNAMIC_FUNC1(FlxTypedSpriteGroup_obj,scrollFactorCallback,(void))
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadGraphicFromSprite( ::flixel::FlxSprite Sprite){
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1102_loadGraphicFromSprite)
HXDLIN(1102)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
...
HXDLIN(1114)		return ::hx::ObjectPtr<OBJ_>(this);
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::loadRotatedGraphic( ::Dynamic Graphic,::hx::Null< int >  __o_Rotations,::hx::Null< int >  __o_Frame,::hx::Null< bool >  __o_AntiAliasing,::hx::Null< bool >  __o_AutoBuffer,::String Key){
            	...
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1125_loadRotatedGraphic)
HXDLIN(1125)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));
HXDLIN(1125)		return null();
 ...
 ::flixel::FlxSprite FlxTypedSpriteGroup_obj::makeGraphic(int Width,int Height,::hx::Null< int >  __o__tmp_Color,::hx::Null< bool >  __o_Unique,::String Key){
            		...
            		bool Unique = __o_Unique.Default(false);
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_1137_makeGraphic)
HXDLIN(1137)		int Color = _tmp_Color;
HXDLIN(1137)		HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("This function is not supported in FlxSpriteGroup",d4,53,54,91)));

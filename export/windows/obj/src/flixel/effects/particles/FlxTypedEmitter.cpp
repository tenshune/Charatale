...
HXLINE( 352)				 ::flixel::effects::particles::FlxTypedEmitter _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 352)				_hx_tmp1->_timer = (_hx_tmp1->_timer - this->frequency);
...
HXDLIN( 445)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN( 445)				point1->_inPool = false;
HXDLIN( 445)				this->_point = point1;
...
HXDLIN( 451)				 ::flixel::math::FlxBasePoint point2 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y2);
HXDLIN( 451)				point2->_inPool = false;
HXDLIN( 451)				this->_point = point2;
HXLINE( 452)				{
...
HXLINE( 456)				{
HXLINE( 456)					 ::flixel::math::FlxBasePoint this3 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("velocityRange",60,4a,a1,8e),::hx::paccDynamic)) )->start) );
HXDLIN( 456)					this3->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->velocity->start->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->velocity->start->max) )->x,null()));
            				}
HXLINE( 457)				{
HXLINE( 457)					 ::flixel::math::FlxBasePoint this4 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("velocityRange",60,4a,a1,8e),::hx::paccDynamic)) )->start) );
HXDLIN( 457)					this4->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->velocity->start->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->velocity->start->max) )->y,null()));
            				}
HXLINE( 458)				{
HXLINE( 458)					 ::flixel::math::FlxBasePoint this5 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("velocityRange",60,4a,a1,8e),::hx::paccDynamic)) )->end) );
HXDLIN( 458)					this5->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->velocity->end->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->velocity->end->max) )->x,null()));
            				}
HXLINE( 459)				{
HXLINE( 459)					 ::flixel::math::FlxBasePoint this6 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("velocityRange",60,4a,a1,8e),::hx::paccDynamic)) )->end) );
HXDLIN( 459)					this6->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->velocity->end->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->velocity->end->max) )->y,null()));
            				}
...
HXLINE( 468)			_hx_tmp1 = ::hx::IsInstanceNotEq( this->angularVelocity->start,this->angularVelocity->end );
            		}
            		else {
HXLINE( 468)			_hx_tmp1 = false;
            		}
HXDLIN( 468)		( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("angularVelocityRange",1e,c6,ce,3a),::hx::paccDynamic)) )->active = _hx_tmp1;
...
HXLINE( 487)				Float _hx_tmp2 = ::flixel::FlxG_obj::random->_hx_float(this->angle->end->min,this->angle->end->max,null());
HXDLIN( 487)				Float _hx_tmp3 = (_hx_tmp2 - ::flixel::FlxG_obj::random->_hx_float(this->angle->start->min,this->angle->start->max,null()));
HXDLIN( 487)				( ( ::flixel::FlxObject)(particle) )->angularVelocity = (_hx_tmp3 / ::flixel::FlxG_obj::random->_hx_float(this->lifespan->min,this->lifespan->max,null()));
...
HXLINE( 499)			{
HXLINE( 499)				 ::flixel::math::FlxBasePoint this7 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->start) );
HXDLIN( 499)				this7->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->scale->start->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->scale->start->max) )->x,null()));
            			}
HXLINE( 500)			{
HXLINE( 500)				 ::flixel::math::FlxBasePoint this8 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->start) );
HXDLIN( 500)				Float y4;
HXDLIN( 500)				if (this->keepScaleRatio) {
HXLINE( 500)					y4 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->start) )->x;
            				}
            				else {
HXLINE( 500)					y4 = ::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->scale->start->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->scale->start->max) )->y,null());
            				}
HXDLIN( 500)				this8->set_y(y4);
            			}
HXLINE( 501)			{
HXLINE( 501)				 ::flixel::math::FlxBasePoint this9 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->end) );
HXDLIN( 501)				this9->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->scale->end->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->scale->end->max) )->x,null()));
            			}
HXLINE( 502)			{
HXLINE( 502)				 ::flixel::math::FlxBasePoint this10 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->end) );
HXDLIN( 502)				Float y5;
HXDLIN( 502)				if (this->keepScaleRatio) {
HXLINE( 502)					y5 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->end) )->x;
            				}
            				else {
HXLINE( 502)					y5 = ::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->scale->end->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->scale->end->max) )->y,null());
            				}
HXDLIN( 502)				this10->set_y(y5);
            			}
HXLINE( 503)			bool _hx_tmp4;
HXDLIN( 503)			if (::hx::IsGreater( particle->__Field(HX_("lifespan",c6,19,ce,6b),::hx::paccDynamic),0 )) {
HXLINE( 503)				 ::flixel::math::FlxBasePoint _this1 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->start) );
HXDLIN( 503)				 ::flixel::math::FlxBasePoint point3 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->end) );
HXDLIN( 503)				bool result1;
HXDLIN( 503)				if ((::Math_obj::abs((_this1->x - point3->x)) <= ((Float)0.0000001))) {
HXLINE( 503)					result1 = (::Math_obj::abs((_this1->y - point3->y)) <= ((Float)0.0000001));
            				}
            				else {
HXLINE( 503)					result1 = false;
            				}
HXDLIN( 503)				if (point3->_weak) {
HXLINE( 503)					point3->put();
            				}
HXDLIN( 503)				_hx_tmp4 = !(result1);
            			}
            			else {
HXLINE( 503)				_hx_tmp4 = false;
            			}
HXDLIN( 503)			( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("scaleRange",d3,52,53,05),::hx::paccDynamic)) )->active = _hx_tmp4;
...
HXLINE( 517)			bool _hx_tmp5;
HXDLIN( 517)			if (::hx::IsGreater( particle->__Field(HX_("lifespan",c6,19,ce,6b),::hx::paccDynamic),0 )) {
HXLINE( 517)				_hx_tmp5 = ::hx::IsNotEq( ( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("alphaRange",7f,f9,c4,04),::hx::paccDynamic)) )->start,( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("alphaRange",7f,f9,c4,04),::hx::paccDynamic)) )->end );
            			}
            			else {
HXLINE( 517)				_hx_tmp5 = false;
            			}
HXDLIN( 517)			( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("alphaRange",7f,f9,c4,04),::hx::paccDynamic)) )->active = _hx_tmp5;
...
HXLINE( 528)				_hx_tmp6 = ::hx::IsNotEq( ( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("colorRange",5a,bd,8b,08),::hx::paccDynamic)) )->start,( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("colorRange",5a,bd,8b,08),::hx::paccDynamic)) )->end );
            			}
            			else {
HXLINE( 528)				_hx_tmp6 = false;
            			}
HXDLIN( 528)			( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("colorRange",5a,bd,8b,08),::hx::paccDynamic)) )->active = _hx_tmp6;
...
HXLINE( 537)			{
HXLINE( 537)				 ::flixel::math::FlxBasePoint this11 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->start) );
HXDLIN( 537)				this11->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->drag->start->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->drag->start->max) )->x,null()));
            			}
HXLINE( 538)			{
HXLINE( 538)				 ::flixel::math::FlxBasePoint this12 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->start) );
HXDLIN( 538)				this12->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->drag->start->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->drag->start->max) )->y,null()));
            			}
HXLINE( 539)			{
HXLINE( 539)				 ::flixel::math::FlxBasePoint this13 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->end) );
HXDLIN( 539)				this13->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->drag->end->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->drag->end->max) )->x,null()));
            			}
HXLINE( 540)			{
HXLINE( 540)				 ::flixel::math::FlxBasePoint this14 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->end) );
HXDLIN( 540)				this14->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->drag->end->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->drag->end->max) )->y,null()));
            			}
HXLINE( 541)			bool _hx_tmp7;
HXDLIN( 541)			if (::hx::IsGreater( particle->__Field(HX_("lifespan",c6,19,ce,6b),::hx::paccDynamic),0 )) {
HXLINE( 541)				 ::flixel::math::FlxBasePoint _this2 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->start) );
HXDLIN( 541)				 ::flixel::math::FlxBasePoint point4 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->end) );
HXDLIN( 541)				bool result2;
HXDLIN( 541)				if ((::Math_obj::abs((_this2->x - point4->x)) <= ((Float)0.0000001))) {
HXLINE( 541)					result2 = (::Math_obj::abs((_this2->y - point4->y)) <= ((Float)0.0000001));
            				}
            				else {
HXLINE( 541)					result2 = false;
            				}
HXDLIN( 541)				if (point4->_weak) {
HXLINE( 541)					point4->put();
            				}
HXDLIN( 541)				_hx_tmp7 = !(result2);
            			}
            			else {
HXLINE( 541)				_hx_tmp7 = false;
            			}
HXDLIN( 541)			( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("dragRange",29,15,75,46),::hx::paccDynamic)) )->active = _hx_tmp7;
...
HXLINE( 551)			{
HXLINE( 551)				 ::flixel::math::FlxBasePoint this15 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->start) );
HXDLIN( 551)				this15->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->acceleration->start->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->acceleration->start->max) )->x,null()));
            			}
HXLINE( 552)			{
HXLINE( 552)				 ::flixel::math::FlxBasePoint this16 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->start) );
HXDLIN( 552)				this16->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->acceleration->start->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->acceleration->start->max) )->y,null()));
            			}
HXLINE( 553)			{
HXLINE( 553)				 ::flixel::math::FlxBasePoint this17 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->end) );
HXDLIN( 553)				this17->set_x(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->acceleration->end->min) )->x,( ( ::flixel::math::FlxBasePoint)(this->acceleration->end->max) )->x,null()));
            			}
HXLINE( 554)			{
HXLINE( 554)				 ::flixel::math::FlxBasePoint this18 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->end) );
HXDLIN( 554)				this18->set_y(::flixel::FlxG_obj::random->_hx_float(( ( ::flixel::math::FlxBasePoint)(this->acceleration->end->min) )->y,( ( ::flixel::math::FlxBasePoint)(this->acceleration->end->max) )->y,null()));
            			}
HXLINE( 555)			bool _hx_tmp8;
HXDLIN( 555)			if (::hx::IsGreater( particle->__Field(HX_("lifespan",c6,19,ce,6b),::hx::paccDynamic),0 )) {
HXLINE( 556)				 ::flixel::math::FlxBasePoint _this3 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->start) );
HXDLIN( 556)				 ::flixel::math::FlxBasePoint point5 = ( ( ::flixel::math::FlxBasePoint)(( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->end) );
HXDLIN( 556)				bool result3;
HXDLIN( 556)				if ((::Math_obj::abs((_this3->x - point5->x)) <= ((Float)0.0000001))) {
HXLINE( 556)					result3 = (::Math_obj::abs((_this3->y - point5->y)) <= ((Float)0.0000001));
            				}
            				else {
HXLINE( 556)					result3 = false;
            				}
HXDLIN( 556)				if (point5->_weak) {
HXLINE( 556)					point5->put();
            				}
HXLINE( 555)				_hx_tmp8 = !(result3);
            			}
            			else {
HXLINE( 555)				_hx_tmp8 = false;
            			}
HXDLIN( 555)			( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("accelerationRange",5d,2d,23,34),::hx::paccDynamic)) )->active = _hx_tmp8;
...
HXLINE( 568)			bool _hx_tmp9;
HXDLIN( 568)			if (::hx::IsGreater( particle->__Field(HX_("lifespan",c6,19,ce,6b),::hx::paccDynamic),0 )) {
HXLINE( 568)				_hx_tmp9 = ::hx::IsNotEq( ( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("elasticityRange",84,bb,e8,db),::hx::paccDynamic)) )->start,( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("elasticityRange",84,bb,e8,db),::hx::paccDynamic)) )->end );
            			}
            			else {
HXLINE( 568)				_hx_tmp9 = false;
            			}
HXDLIN( 568)			( ( ::flixel::util::helpers::FlxRange)(particle->__Field(HX_("elasticityRange",84,bb,e8,db),::hx::paccDynamic)) )->active = _hx_tmp9;
...
HXLINE( 575)		Float _hx_tmp10 = ::flixel::FlxG_obj::random->_hx_float(this->x,(this->x + this->width),null());
HXDLIN( 575)		( ( ::flixel::FlxObject)(particle) )->set_x((_hx_tmp10 - (( ( ::flixel::FlxObject)(particle) )->get_width() / ( (Float)(2) ))));
HXLINE( 576)		Float _hx_tmp11 = ::flixel::FlxG_obj::random->_hx_float(this->y,(this->y + this->height),null());
HXDLIN( 576)		( ( ::flixel::FlxObject)(particle) )->set_y((_hx_tmp11 - (( ( ::flixel::FlxObject)(particle) )->get_height() / ( (Float)(2) ))));

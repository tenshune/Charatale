...
HXDLIN(  57)		if (::hx::IsNotNull( ::flixel::FlxG_obj::game )) {
HXLINE(  57)			_hx_tmp = ::hx::IsNull( ::flixel::FlxG_obj::game->debugger );
            		}
            		else {
HXLINE(  57)			_hx_tmp = true;
            		}
HXDLIN(  57)		if (_hx_tmp) {
HXLINE(  59)			this->_standardTraceFunction(data,::hx::SourceInfo(HX_("flixel/system/frontEnds/LogFrontEnd.hx",c3,b8,6a,68),59,HX_("flixel.system.frontEnds.LogFrontEnd",5c,bd,97,07),HX_("advanced",a2,69,7b,3b)));
            		}
            		else {
HXLINE(  61)			if (::flixel::FlxG_obj::game->debugger->log->add(( (::cpp::VirtualArray)(data) ),style,fireOnce)) {
HXLINE(  64)				if (::hx::IsNotNull( style->errorSound )) {
HXLINE(  66)					 ::openfl::media::Sound sound = ::flixel::_hx_system::FlxAssets_obj::getSound(style->errorSound);
HXLINE(  67)					if (::hx::IsNotNull( sound )) {
HXLINE(  68)						::flixel::FlxG_obj::sound->load(sound,null(),null(),null(),null(),null(),null(),null(),null())->play(null(),null(),null());
            					}
            				}
HXLINE(  72)				if (style->openConsole) {
HXLINE(  73)					::flixel::FlxG_obj::debugger->set_visible(true);
            				}
HXLINE(  75)				if (::hx::IsNotNull( style->callbackFunction )) {
HXLINE(  76)					style->callbackFunction();
            				}
            			}
            		}
HXLINE(  80)		if (style->throwException) {
HXLINE(  81)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(style->toLogString(( (::cpp::VirtualArray)(data) ))));
            		}
            	}
...
HXDLIN(  90)		::flixel::FlxG_obj::game->debugger->log->clear();
            	}

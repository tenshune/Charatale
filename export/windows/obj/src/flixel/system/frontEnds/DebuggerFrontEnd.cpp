...
HXLINE( 114)			 ::flixel::_hx_system::debug::FlxDebugger _this1 = ::flixel::FlxG_obj::game->debugger;
...
HXDLIN( 114)			_this1->_windows->push(window);
HXDLIN( 114)			_this1->addChild(window);
HXDLIN( 114)			if (::hx::IsNotNull( _this1->_screenBounds )) {
HXLINE( 114)				_this1->updateBounds();

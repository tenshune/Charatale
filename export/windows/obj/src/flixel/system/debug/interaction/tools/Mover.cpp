...
HXLINE(  25)		 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,brain->flixelPointer->x,brain->flixelPointer->x);
HXDLIN(  25)		this->_lastCursorPosition = this1;
...
HXLINE(  44)				_hx_tmp = this->_dragging;
            			}
            			else {

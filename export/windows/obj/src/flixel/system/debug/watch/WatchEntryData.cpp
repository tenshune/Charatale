...
::flixel::_hx_system::debug::watch::WatchEntryData WatchEntryData_obj::FUNCTION( ::Dynamic func)
{
	return ::hx::CreateEnum< WatchEntryData_obj >(HX_("FUNCTION",18,3b,d8,6d),3,1)->_hx_init(0,func);
}
...
bool WatchEntryData_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("FUNCTION",18,3b,d8,6d)) { outValue = WatchEntryData_obj::FUNCTION_dyn(); return true; }
...
int WatchEntryData_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("FUNCTION",18,3b,d8,6d)) return 3;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(WatchEntryData_obj,FUNCTION,return)
...
::hx::Val WatchEntryData_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("FUNCTION",18,3b,d8,6d)) return FUNCTION_dyn();

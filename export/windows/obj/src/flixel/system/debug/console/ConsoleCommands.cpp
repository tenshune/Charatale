...
HXLINE(  99)					_hx_tmp = HX_("()",01,23,00,00);
            				}
            				else {
HXLINE(  99)					_hx_tmp = HX_("",00,00,00,00);
            				}
HXDLIN(  99)				return (((Alias + _hx_tmp) + HX_(": ",a6,32,00,00)) + this->_console->registeredHelp->get(Alias));
            			}
            			else {
...
HXLINE( 135)			::String text = ((HX_("create: New ",82,f9,21,bf) + ::Std_obj::string(ObjClass)) + HX_(" created at X = ",00,f4,df,3b));
HXDLIN( 135)			::String text1 = ((((text + obj->x) + HX_(" Y = ",ca,0a,bf,a7)) + obj->y) + HX_(" with params ",20,c2,85,fb));
HXDLIN( 135)			 ::Dynamic text2 = (text1 + ::Std_obj::string(Params));
HXDLIN( 135)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,text2),::flixel::_hx_system::debug::log::LogStyle_obj::CONSOLE,null());
            		}
...
HXLINE( 142)		{
HXLINE( 142)			 ::Dynamic text = ((((HX_("create: ",a2,50,f4,2b) + ::Std_obj::string(ObjClass)) + HX_(" registered as '",b7,f0,b7,dc)) + name) + HX_("'",27,00,00,00));
...
HXLINE( 169)			{
HXLINE( 169)				 ::flixel::_hx_system::frontEnds::WatchFrontEnd _this = ::flixel::FlxG_obj::watch;

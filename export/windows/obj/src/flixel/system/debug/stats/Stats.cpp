...
HXLINE( 246)			 ::flixel::_hx_system::debug::stats::StatsGraph _hx_tmp1 = this->memoryGraph;
HXDLIN( 246)			_hx_tmp1->update(((( (Float)(::openfl::_hx_system::System_obj::get_totalMemory()) ) / ( (Float)(1024) )) / ( (Float)(1000) )));
...
HXLINE( 255)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 255)					_hx_tmp2->updateTime = (_hx_tmp2->updateTime + this->_update->__get(i));
            				}
            			}
HXLINE( 258)			{
...
HXDLIN( 258)					int i1 = (_g2 - 1);
HXLINE( 260)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 260)					_hx_tmp3->activeCount = (_hx_tmp3->activeCount + this->_activeObject->__get(i1));
            				}
            			}
...
HXDLIN( 265)					int i2 = (_g4 - 1);
HXLINE( 267)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 267)					_hx_tmp4->drawTime = (_hx_tmp4->drawTime + this->_draw->__get(i2));
            				}
            			}
HXLINE( 270)			{
...
HXDLIN( 270)					int i3 = (_g6 - 1);
HXLINE( 272)					 ::flixel::_hx_system::debug::stats::Stats _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 272)					_hx_tmp5->visibleCount = (_hx_tmp5->visibleCount + this->_visibleObject->__get(i3));
            				}
            			}
...
HXDLIN( 278)					int _g9 = this->_drawCallsMarker;
HXDLIN( 278)					while((_g8 < _g9)){
HXLINE( 278)						_g8 = (_g8 + 1);
HXDLIN( 278)						int i4 = (_g8 - 1);
HXLINE( 280)						 ::flixel::_hx_system::debug::stats::Stats _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 280)						_hx_tmp6->drawCallsCount = (_hx_tmp6->drawCallsCount + this->_drawCalls->__get(i4));
            					}
            				}
...
HXLINE( 294)			 ::flixel::_hx_system::debug::stats::Stats _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 294)			_hx_tmp7->_updateTimer = (_hx_tmp7->_updateTimer - 250);
            		}
            	}
...
HXLINE( 431)			 ::flixel::_hx_system::ui::FlxSystemButton _hx_tmp1 = this->_toggleSizeButton;
HXDLIN( 431)			_hx_tmp1->changeIcon( ::flixel::_hx_system::debug::stats::_Stats::GraphicMaximizeButton_obj::__alloc( HX_CTX ,0,0,null(),null()));
            		}

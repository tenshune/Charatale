...
HXLINE( 180)			 ::openfl::display::Bitmap _hx_tmp2 = this->_canvasBitmap;
HXDLIN( 180)			_hx_tmp2->set_bitmapData( ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,newWidth1,newHeight2,true,0));
HXLINE( 181)			this->refreshCanvas(this->_curIndex);
            		}
HXLINE( 184)		 ::openfl::display::Sprite _hx_tmp3 = this->_ui;
HXDLIN( 184)		Float _hx_tmp4 = this->_header->get_width();
HXDLIN( 184)		_hx_tmp3->set_x(((_hx_tmp4 - this->_ui->get_width()) - ( (Float)(5) )));
HXLINE( 186)		this->_footer->set_width(( (Float)(this->_width) ));
HXLINE( 187)		 ::openfl::display::Bitmap _hx_tmp5 = this->_footer;
HXDLIN( 187)		int _hx_tmp6 = this->_height;
HXDLIN( 187)		_hx_tmp5->set_y((( (Float)(_hx_tmp6) ) - this->_footer->get_height()));

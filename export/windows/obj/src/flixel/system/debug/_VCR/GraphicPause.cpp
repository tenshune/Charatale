...
HX_DEFINE_STACK_FRAME(_hx_pos_2a3fa164fc45c190_47_new,"flixel.system.debug._VCR.GraphicPause","new",0x93ef75a0,"flixel.system.debug._VCR.GraphicPause.new","openfl/utils/_internal/AssetsMacro.hx",47,0xfdd54705)
...
void GraphicPause_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_2a3fa164fc45c190_47_new)

...
HX_DEFINE_STACK_FRAME(_hx_pos_eeef98c53cb575cc_2013_new,"openfl.text._internal._TextEngine.DefaultFontSet","new",0xe216cf59,"openfl.text._internal._TextEngine.DefaultFontSet.new","openfl/text/_internal/TextEngine.hx",2013,0xb85e1839)
HX_LOCAL_STACK_FRAME(_hx_pos_eeef98c53cb575cc_2021_getFont,"openfl.text._internal._TextEngine.DefaultFontSet","getFont",0x27237cfe,"openfl.text._internal._TextEngine.DefaultFontSet.getFont","openfl/text/_internal/TextEngine.hx",2021,0xb85e1839)
namespace openfl{
namespace text{
namespace _internal{
...
void DefaultFontSet_obj::__construct( ::openfl::text::Font normal, ::openfl::text::Font bold, ::openfl::text::Font italic, ::openfl::text::Font boldItalic){
            	HX_STACKFRAME(&_hx_pos_eeef98c53cb575cc_2013_new)
HXLINE(2014)		this->normal = normal;
HXLINE(2015)		this->bold = bold;
HXLINE(2016)		this->italic = italic;
HXLINE(2017)		this->boldItalic = boldItalic;
            	}
...
bool DefaultFontSet_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::text::Font DefaultFontSet_obj::getFont(bool isBold,bool isItalic){
            	HX_STACKFRAME(&_hx_pos_eeef98c53cb575cc_2021_getFont)
HXLINE(2022)		bool _hx_tmp;
HXDLIN(2022)		bool _hx_tmp1;
HXDLIN(2022)		if (isBold) {
HXLINE(2022)			_hx_tmp1 = isItalic;
            		}
            		else {
HXLINE(2022)			_hx_tmp1 = false;
            		}
HXDLIN(2022)		if (_hx_tmp1) {
HXLINE(2022)			_hx_tmp = ::hx::IsNotNull( this->boldItalic );
            		}
            		else {
HXLINE(2022)			_hx_tmp = false;
            		}
HXDLIN(2022)		if (_hx_tmp) {
HXLINE(2024)			return this->boldItalic;
            		}
HXLINE(2026)		bool _hx_tmp2;
HXDLIN(2026)		if (isItalic) {
HXLINE(2026)			_hx_tmp2 = ::hx::IsNotNull( this->italic );
            		}
            		else {
HXLINE(2026)			_hx_tmp2 = false;
            		}
HXDLIN(2026)		if (_hx_tmp2) {
HXLINE(2028)			return this->italic;
            		}
HXLINE(2030)		bool _hx_tmp3;
HXDLIN(2030)		if (isBold) {
HXLINE(2030)			_hx_tmp3 = ::hx::IsNotNull( this->bold );
            		}
            		else {
HXLINE(2030)			_hx_tmp3 = false;
            		}
HXDLIN(2030)		if (_hx_tmp3) {
HXLINE(2032)			return this->bold;
            		}
HXLINE(2034)		return this->normal;
            	}

...
HXLINE(2907)			bool _hx_tmp1;
HXDLIN(2907)			if (::hx::IsNotNull( this->stage )) {
HXLINE(2907)				_hx_tmp1 = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(2962)					_hx_tmp1 = ::hx::IsInstanceNotEq( value,this->_hx___styleSheet );
            				}
            				else {
...
HXDLIN(3006)				::cpp::VirtualArray _g_args = ::cpp::VirtualArray_obj::__new(0);
...
HXLINE(3255)			bool _hx_tmp2;
HXDLIN(3255)			bool _hx_tmp3;
HXDLIN(3255)			bool _hx_tmp4;
HXDLIN(3255)			if (::hx::IsNotEq( this->get_type(),1 )) {
HXLINE(3255)				_hx_tmp4 = this->get_selectable();
            			}
            			else {
HXLINE(3255)				_hx_tmp4 = false;
            			}
HXDLIN(3255)			if (_hx_tmp4) {
HXLINE(3255)				_hx_tmp3 = ::hx::IsNotNull( this->stage );
            			}
            			else {
HXLINE(3255)				_hx_tmp3 = false;
            			}
HXDLIN(3255)			if (_hx_tmp3) {
HXLINE(3255)				_hx_tmp2 = ::hx::IsInstanceEq( this->stage->get_focus(),::hx::ObjectPtr<OBJ_>(this) );
            			}
            			else {
...
HXLINE(3282)			bool _hx_tmp3;
HXDLIN(3282)			if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3282)				_hx_tmp3 = !(this->get_displayAsPassword());
            			}
            			else {
...
HXLINE(3345)						bool _hx_tmp2;
HXDLIN(3345)						if ((pos < rightPos)) {
HXLINE(3345)							_hx_tmp2 = (pos != -1);
            						}
            						else {
...
HXLINE(3594)					bool _hx_tmp1;
HXDLIN(3594)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3594)						_hx_tmp1 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3594)						_hx_tmp1 = false;
            					}
HXDLIN(3594)					if (_hx_tmp1) {
HXLINE(3596)						this->setSelection(0,this->_hx___text.length);
            			...
            			break;
            			case (int)99: {
HXLINE(3543)				bool _hx_tmp2;
HXDLIN(3543)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3543)					_hx_tmp2 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3543)					_hx_tmp2 = false;
            				}
HXDLIN(3543)				if (_hx_tmp2) {
HXLINE(3545)					bool _hx_tmp3;
HXDLIN(3545)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3545)						_hx_tmp3 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3545)						_hx_tmp3 = false;
            					}
HXDLIN(3545)					if (_hx_tmp3) {
HXLINE(3547)						::lime::_hx_system::Clipboard_obj::set_text(this->_hx___text.substring(this->_hx___caretIndex,this->_hx___selectionIndex));
            			...
            			break;
            			case (int)118: {
HXLINE(3569)				bool _hx_tmp4;
HXDLIN(3569)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3569)					_hx_tmp4 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3569)					_hx_tmp4 = false;
            				}
HXDLIN(3569)				if (_hx_tmp4) {
...
HXDLIN(3588)					( ( ::openfl::_Vector::ObjectVector)(this1) )->get((this->_hx___textEngine->textFormatRanges->get_length() - 1)).StaticCast<  ::openfl::text::_internal::TextFormatRange >()->end = this->_hx___text.length;
            			...
            			break;
            			case (int)120: {
HXLINE(3554)				bool _hx_tmp5;
HXDLIN(3554)				if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3554)					_hx_tmp5 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            				}
            				else {
HXLINE(3554)					_hx_tmp5 = false;
            				}
HXDLIN(3554)				if (_hx_tmp5) {
HXLINE(3556)					bool _hx_tmp6;
HXDLIN(3556)					if ((this->_hx___caretIndex != this->_hx___selectionIndex)) {
HXLINE(3556)						_hx_tmp6 = !(this->get_displayAsPassword());
            					}
            					else {
HXLINE(3556)						_hx_tmp6 = false;
            					}
HXDLIN(3556)					if (_hx_tmp6) {
...
HXLINE(3561)						this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),true,null()));
            			...
            			break;
            			case (int)127: {
HXLINE(3421)				bool _hx_tmp7;
HXDLIN(3421)				if ((this->_hx___selectionIndex == this->_hx___caretIndex)) {
HXLINE(3421)					_hx_tmp7 = (this->_hx___caretIndex < this->_hx___text.length);
            				}
            				else {
HXLINE(3421)					_hx_tmp7 = false;
            				}
HXDLIN(3421)				if (_hx_tmp7) {
...
HXLINE(3508)					bool _hx_tmp8;
HXDLIN(3508)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3508)						_hx_tmp8 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3508)						_hx_tmp8 = false;
            					}
HXDLIN(3508)					if (_hx_tmp8) {
...
HXLINE(3525)					bool _hx_tmp9;
HXDLIN(3525)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3525)						_hx_tmp9 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3525)						_hx_tmp9 = false;
            					}
HXDLIN(3525)					if (_hx_tmp9) {
...
HXLINE(3457)					bool _hx_tmp10;
HXDLIN(3457)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3457)						_hx_tmp10 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3457)						_hx_tmp10 = false;
            					}
HXDLIN(3457)					if (_hx_tmp10) {
...
HXLINE(3440)					bool _hx_tmp11;
HXDLIN(3440)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3440)						_hx_tmp11 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3440)						_hx_tmp11 = false;
            					}
HXDLIN(3440)					if (_hx_tmp11) {
...
HXLINE(3474)					bool _hx_tmp12;
HXDLIN(3474)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3474)						_hx_tmp12 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3474)						_hx_tmp12 = false;
            					}
HXDLIN(3474)					if (_hx_tmp12) {
...
HXLINE(3491)					bool _hx_tmp13;
HXDLIN(3491)					if (::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_ctrlKey(modifier)) {
HXLINE(3491)						_hx_tmp13 = !(::lime::ui::_KeyModifier::KeyModifier_Impl__obj::get_altKey(modifier));
            					}
            					else {
HXLINE(3491)						_hx_tmp13 = false;
            					}
HXDLIN(3491)					if (_hx_tmp13) {
...
HXLINE(3384)					 ::openfl::events::TextEvent te1 =  ::openfl::events::TextEvent_obj::__alloc( HX_CTX ,HX_("textInput",1d,54,0b,57),true,true,HX_("\n",0a,00,00,00));
HXLINE(3386)					this->dispatchEvent(te1);
HXLINE(3388)					if (!(te1->isDefaultPrevented())) {

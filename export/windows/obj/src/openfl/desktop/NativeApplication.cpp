...
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_169_get_activeWindow,"openfl.desktop.NativeApplication","get_activeWindow",0x866ea384,"openfl.desktop.NativeApplication.get_activeWindow","openfl/desktop/NativeApplication.hx",169,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_181_get_applicationID,"openfl.desktop.NativeApplication","get_applicationID",0xb1dea63d,"openfl.desktop.NativeApplication.get_applicationID","openfl/desktop/NativeApplication.hx",181,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_232_get_isCompiledAOT,"openfl.desktop.NativeApplication","get_isCompiledAOT",0x370bdffd,"openfl.desktop.NativeApplication.get_isCompiledAOT","openfl/desktop/NativeApplication.hx",232,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_248_get_openedWindows,"openfl.desktop.NativeApplication","get_openedWindows",0x3ad181ec,"openfl.desktop.NativeApplication.get_openedWindows","openfl/desktop/NativeApplication.hx",248,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_303_exit,"openfl.desktop.NativeApplication","exit",0xed6e2843,"openfl.desktop.NativeApplication.exit","openfl/desktop/NativeApplication.hx",303,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_324_isSetAsDefaultApplication,"openfl.desktop.NativeApplication","isSetAsDefaultApplication",0x28dfca54,"openfl.desktop.NativeApplication.isSetAsDefaultApplication","openfl/desktop/NativeApplication.hx",324,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_334_removeAsDefaultApplication,"openfl.desktop.NativeApplication","removeAsDefaultApplication",0x23e7e4ea,"openfl.desktop.NativeApplication.removeAsDefaultApplication","openfl/desktop/NativeApplication.hx",334,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_343_setAsDefaultApplication,"openfl.desktop.NativeApplication","setAsDefaultApplication",0x046a4c5e,"openfl.desktop.NativeApplication.setAsDefaultApplication","openfl/desktop/NativeApplication.hx",343,0xc0103ef7)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_57_get_supportsDefaultApplication,"openfl.desktop.NativeApplication","get_supportsDefaultApplication",0x19079c61,"openfl.desktop.NativeApplication.get_supportsDefaultApplication","openfl/desktop/NativeApplication.hx",57,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_79_get_supportsDockIcon,"openfl.desktop.NativeApplication","get_supportsDockIcon",0xa70a41de,"openfl.desktop.NativeApplication.get_supportsDockIcon","openfl/desktop/NativeApplication.hx",79,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_99_get_supportsMenu,"openfl.desktop.NativeApplication","get_supportsMenu",0xc9b9c671,"openfl.desktop.NativeApplication.get_supportsMenu","openfl/desktop/NativeApplication.hx",99,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_114_get_supportsStartAtLogin,"openfl.desktop.NativeApplication","get_supportsStartAtLogin",0x40bdaa06,"openfl.desktop.NativeApplication.get_supportsStartAtLogin","openfl/desktop/NativeApplication.hx",114,0xc0103ef7)
HX_LOCAL_STACK_FRAME(_hx_pos_d993c3fd7589a798_139_get_supportsSystemTrayIcon,"openfl.desktop.NativeApplication","get_supportsSystemTrayIcon",0xdb00b1f0,"openfl.desktop.NativeApplication.get_supportsSystemTrayIcon","openfl/desktop/NativeApplication.hx",139,0xc0103ef7)
namespace openfl{
namespace desktop{

void NativeApplication_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_21_new)
HXLINE( 235)		this->_hx___openedWindows = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 220)		this->icon = null();
HXLINE( 197)		this->autoExit = true;
HXLINE( 279)		super::__construct(null());
            	}
...
bool NativeApplication_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::NativeWindow NativeApplication_obj::get_activeWindow(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_169_get_activeWindow)
HXDLIN( 169)		return this->_hx___activeWindow;
            	}
...
::String NativeApplication_obj::get_applicationID(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_181_get_applicationID)
HXDLIN( 181)		return ::openfl::utils::_internal::Lib_obj::application->meta->get_string(HX_("packageName",f1,04,ad,04));
            	}
...
bool NativeApplication_obj::get_isCompiledAOT(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_232_get_isCompiledAOT)
...
::Array< ::Dynamic> NativeApplication_obj::get_openedWindows(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_248_get_openedWindows)
HXDLIN( 248)		return this->_hx___openedWindows->copy();
            	}
...
void NativeApplication_obj::exit(::hx::Null< int >  __o_code){
            	...
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_303_exit)
HXDLIN( 303)		::lime::_hx_system::System_obj::exit(code);
            	}
...
bool NativeApplication_obj::isSetAsDefaultApplication(::String extension){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_324_isSetAsDefaultApplication)
...
void NativeApplication_obj::removeAsDefaultApplication(::String extension){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_334_removeAsDefaultApplication)
            	}
...
void NativeApplication_obj::setAsDefaultApplication(::String extension){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_343_setAsDefaultApplication)
            	}
...
bool NativeApplication_obj::get_supportsDefaultApplication(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_57_get_supportsDefaultApplication)
...
bool NativeApplication_obj::get_supportsDockIcon(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_79_get_supportsDockIcon)
...
bool NativeApplication_obj::get_supportsMenu(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_99_get_supportsMenu)
...
bool NativeApplication_obj::get_supportsStartAtLogin(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_114_get_supportsStartAtLogin)
...
bool NativeApplication_obj::get_supportsSystemTrayIcon(){
            	HX_STACKFRAME(&_hx_pos_d993c3fd7589a798_139_get_supportsSystemTrayIcon)

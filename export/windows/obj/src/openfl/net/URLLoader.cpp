...
HXLINE( 387)			int _g = 0;
HXDLIN( 387)			::Array< ::Dynamic> _g1 = request->requestHeaders;
HXDLIN( 387)			while((_g < _g1->length)){
HXLINE( 387)				 ::openfl::net::URLRequestHeader header = _g1->__get(_g).StaticCast<  ::openfl::net::URLRequestHeader >();
HXDLIN( 387)				_g = (_g + 1);
HXLINE( 389)				::Array< ::Dynamic> _hx_tmp = ( (::Array< ::Dynamic>)(this->_hx___httpRequest->__Field(HX_("headers",46,52,08,63),::hx::paccDynamic)) );
HXDLIN( 389)				_hx_tmp->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,header->name,header->value));
            			}
            		}
...
HXLINE( 438)			 ::openfl::events::IOErrorEvent event =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
HXLINE( 439)			event->text = ::Std_obj::string(error);
HXLINE( 440)			this->dispatchEvent(event);
            		}
            	}

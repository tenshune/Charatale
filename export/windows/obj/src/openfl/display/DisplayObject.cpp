...
HXLINE(1612)				_hx_tmp = -(_this1->tx);
            			}
            			else {
HXLINE(1612)				_hx_tmp = ((((Float)1.0) / norm1) * ((_this1->c * (_this1->ty - global->y)) + (_this1->d * (global->x - _this1->tx))));
            			}
HXDLIN(1612)			local->x = _hx_tmp;
HXLINE(1613)			 ::openfl::geom::Matrix _this2 = this->_hx___renderTransform;
HXDLIN(1613)			Float norm2 = ((_this2->a * _this2->d) - (_this2->b * _this2->c));
HXDLIN(1613)			Float _hx_tmp1;
HXDLIN(1613)			if ((norm2 == 0)) {
HXLINE(1613)				_hx_tmp1 = -(_this2->ty);
            			}
            			else {
HXLINE(1613)				_hx_tmp1 = ((((Float)1.0) / norm2) * ((_this2->a * (global->y - _this2->ty)) + (_this2->b * (_this2->tx - global->x))));
            			}
...
HXLINE(1628)				bool _hx_tmp3;
HXDLIN(1628)				if (::hx::IsNotNull( stack )) {
HXLINE(1628)					_hx_tmp3 = !(interactiveOnly);
            				}
            				else {
HXLINE(1628)					_hx_tmp3 = false;
            				}
HXDLIN(1628)				if (_hx_tmp3) {
...
HXLINE(1748)				Float _hx_tmp5 = this->get_alpha();
HXDLIN(1748)				this->_hx___worldAlpha = (_hx_tmp5 * renderParent->_hx___worldAlpha);
...
HXLINE(1761)					_hx_tmp6 = ::hx::IsEq( this->_hx___blendMode,10 );
            				}
            				else {
HXLINE(1761)					_hx_tmp6 = true;
            				}
...
HXLINE(1822)		bool _hx_tmp7;
HXDLIN(1822)		if (updateChildren) {
HXLINE(1822)			_hx_tmp7 = ::hx::IsNotNull( this->get_mask() );
            		}
            		else {
HXLINE(1822)			_hx_tmp7 = false;
            		}
HXDLIN(1822)		if (_hx_tmp7) {
...
HXLINE(1856)			 ::openfl::geom::Matrix parentTransform1 = renderParent->_hx___renderTransform;
HXDLIN(1856)			 ::openfl::geom::Matrix target1 = this->_hx___renderTransform;
HXDLIN(1856)			target1->a = ((local->a * parentTransform1->a) + (local->b * parentTransform1->c));
HXDLIN(1856)			target1->b = ((local->a * parentTransform1->b) + (local->b * parentTransform1->d));
HXDLIN(1856)			target1->c = ((local->c * parentTransform1->a) + (local->d * parentTransform1->c));
HXDLIN(1856)			target1->d = ((local->c * parentTransform1->b) + (local->d * parentTransform1->d));
HXDLIN(1856)			target1->tx = (((local->tx * parentTransform1->a) + (local->ty * parentTransform1->c)) + parentTransform1->tx);
HXDLIN(1856)			target1->ty = (((local->tx * parentTransform1->b) + (local->ty * parentTransform1->d)) + parentTransform1->ty);
            		}
            		else {
...
HXLINE(2280)			 ::openfl::geom::ColorTransform _hx_tmp2 = this->_hx___objectTransform->_hx___colorTransform;
HXDLIN(2280)			_hx_tmp2->_hx___copyFrom(value->get_colorTransform());

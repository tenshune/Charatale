...
HXLINE( 276)				 ::openfl::display::ShaderParameter_Float parameter = _g3->__get(_g2).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 276)				_g2 = (_g2 + 1);
HXLINE( 278)				parameter->_hx___useArray = false;
            			}
            		}
HXLINE( 281)		{
...
HXLINE( 281)				 ::openfl::display::ShaderParameter_Int parameter = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 281)				_g4 = (_g4 + 1);
HXLINE( 283)				parameter->_hx___useArray = false;
            			}
            		}
            	}

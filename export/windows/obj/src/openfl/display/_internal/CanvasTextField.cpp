...
HX_LOCAL_STACK_FRAME(_hx_pos_3208549e91c46d80_388_renderDrawable,"openfl.display._internal.CanvasTextField","renderDrawable",0x53844889,"openfl.display._internal.CanvasTextField.renderDrawable","openfl/display/_internal/CanvasTextField.hx",388,0x76b44b48)
HX_LOCAL_STACK_FRAME(_hx_pos_3208549e91c46d80_449_renderDrawableMask,"openfl.display._internal.CanvasTextField","renderDrawableMask",0x545d2e15,"openfl.display._internal.CanvasTextField.renderDrawableMask","openfl/display/_internal/CanvasTextField.hx",449,0x76b44b48)
...
void CanvasTextField_obj::renderDrawable( ::openfl::text::TextField textField, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_3208549e91c46d80_388_renderDrawable)
            	}
...
void CanvasTextField_obj::renderDrawableMask( ::openfl::text::TextField textField, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_3208549e91c46d80_449_renderDrawableMask)
HXDLIN( 449)		::openfl::display::_internal::CanvasDisplayObject_obj::renderDrawableMask(textField,renderer);
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_eed9e911a94343be_511_new,"openfl.events._EventDispatcher.DispatchIterator","new",0x76c2678f,"openfl.events._EventDispatcher.DispatchIterator.new","openfl/events/EventDispatcher.hx",511,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_518_copy,"openfl.events._EventDispatcher.DispatchIterator","copy",0x6c1a6da6,"openfl.events._EventDispatcher.DispatchIterator.copy","openfl/events/EventDispatcher.hx",518,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_527_hasNext,"openfl.events._EventDispatcher.DispatchIterator","hasNext",0xef22001c,"openfl.events._EventDispatcher.DispatchIterator.hasNext","openfl/events/EventDispatcher.hx",527,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_532_next,"openfl.events._EventDispatcher.DispatchIterator","next",0x735836e4,"openfl.events._EventDispatcher.DispatchIterator.next","openfl/events/EventDispatcher.hx",532,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_537_remove,"openfl.events._EventDispatcher.DispatchIterator","remove",0xb5236c75,"openfl.events._EventDispatcher.DispatchIterator.remove","openfl/events/EventDispatcher.hx",537,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_561_reset,"openfl.events._EventDispatcher.DispatchIterator","reset",0xc76e4abe,"openfl.events._EventDispatcher.DispatchIterator.reset","openfl/events/EventDispatcher.hx",561,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_570_start,"openfl.events._EventDispatcher.DispatchIterator","start",0x64b17551,"openfl.events._EventDispatcher.DispatchIterator.start","openfl/events/EventDispatcher.hx",570,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_575_stop,"openfl.events._EventDispatcher.DispatchIterator","stop",0x76b1a1f3,"openfl.events._EventDispatcher.DispatchIterator.stop","openfl/events/EventDispatcher.hx",575,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_502_boot,"openfl.events._EventDispatcher.DispatchIterator","boot",0x6b713623,"openfl.events._EventDispatcher.DispatchIterator.boot","openfl/events/EventDispatcher.hx",502,0xe2270714)
namespace openfl{
namespace events{
namespace _EventDispatcher{

void DispatchIterator_obj::__construct(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_511_new)
HXLINE( 512)		this->active = false;
HXLINE( 513)		this->reset(list);
            	}
...
void DispatchIterator_obj::copy(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_518_copy)
HXDLIN( 518)		if (!(this->isCopy)) {
HXLINE( 520)			this->list = this->list->copy();
HXLINE( 521)			this->isCopy = true;
            		}
            	}
...
bool DispatchIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_527_hasNext)
HXDLIN( 527)		return (this->index < this->list->length);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DispatchIterator_obj,hasNext,return )
 ...
 ::openfl::events::_EventDispatcher::Listener DispatchIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_532_next)
HXDLIN( 532)		return this->list->__get(this->index++).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
            	}
...
void DispatchIterator_obj::remove( ::openfl::events::_EventDispatcher::Listener listener,int listIndex){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_537_remove)
HXDLIN( 537)		if (this->active) {
HXLINE( 539)			if (!(this->isCopy)) {
HXLINE( 541)				if ((listIndex < this->index)) {
HXLINE( 543)					this->index--;
            				}
            			}
            			else {
HXLINE( 548)				int _g = this->index;
HXDLIN( 548)				int _g1 = this->list->length;
HXDLIN( 548)				while((_g < _g1)){
HXLINE( 548)					_g = (_g + 1);
HXDLIN( 548)					int i = (_g - 1);
HXLINE( 550)					if (::hx::IsInstanceEq( this->list->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >(),listener )) {
HXLINE( 552)						this->list->removeRange(i,1);
HXLINE( 553)						goto _hx_goto_4;
            					}
            				}
            				_hx_goto_4:;
            			}
...
void DispatchIterator_obj::reset(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_561_reset)
HXLINE( 562)		this->list = list;
HXLINE( 564)		this->isCopy = false;
HXLINE( 565)		this->index = 0;
            	}
...
void DispatchIterator_obj::start(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_570_start)
HXDLIN( 570)		this->active = true;
            	}
...
void DispatchIterator_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_575_stop)
HXDLIN( 575)		this->active = false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_502_boot)
HXDLIN( 502)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)

...
void Listener_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(weakRefCallback,"weakRefCallback");
...
void Listener_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(weakRefCallback,"weakRefCallback");
...
::hx::Val Listener_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"weakRefCallback") ) { return ::hx::Val( weakRefCallback ); }
		break;
	case 16:
...
::hx::Val Listener_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"weakRefCallback") ) { weakRefCallback=inValue.Cast<  ::cpp::vm::WeakRef >(); return inValue; }
		break;
	case 16:
...
{
	outFields->push(HX_("weakRefCallback",a0,58,d3,81));
...
static ::hx::StorageInfo Listener_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::cpp::vm::WeakRef */ ,(int)offsetof(Listener_obj,weakRefCallback),HX_("weakRefCallback",a0,58,d3,81)},
...
static ::String Listener_obj_sMemberFields[] = {
	...
	HX_("weakRefCallback",a0,58,d3,81),
...
{
{
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_584_boot)
HXDLIN( 584)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)

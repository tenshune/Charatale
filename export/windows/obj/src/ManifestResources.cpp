...
HXLINE(  50)				 ::Dynamic _hx_tmp = ::hx::ClassOf< ::ManifestResources >();
...
HXLINE(  71)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_determination_ttf >());
HXLINE(  72)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_monsterfriendf_otf >());

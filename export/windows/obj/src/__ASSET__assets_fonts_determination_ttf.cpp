...
HX_DEFINE_STACK_FRAME(_hx_pos_d51414fb786e601f_555_new,"__ASSET__assets_fonts_determination_ttf","new",0x158c5115,"__ASSET__assets_fonts_determination_ttf.new","ManifestResources.hx",555,0xf77aa668)

void __ASSET__assets_fonts_determination_ttf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_d51414fb786e601f_555_new)
HXDLIN( 555)		this->_hx___fontPath = (::ManifestResources_obj::rootPath + HX_("assets/fonts/determination.ttf",c4,58,4e,ac));
HXDLIN( 555)		this->name = HX_("Determination Mono Web Regular",30,ab,6a,28);
HXDLIN( 555)		super::__construct(null());
            	}

...
HXLINE( 469)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			...
            			break;
            			case (int)1: {
HXLINE( 472)				 ::lime::ui::Touch touch = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
HXLINE( 474)				if (::hx::IsNotNull( touch )) {
HXLINE( 476)					touch->x = this->touchEventInfo->x;
HXLINE( 477)					touch->y = this->touchEventInfo->y;
HXLINE( 478)					touch->dx = this->touchEventInfo->dx;
HXLINE( 479)					touch->dy = this->touchEventInfo->dy;
HXLINE( 480)					touch->pressure = this->touchEventInfo->pressure;
HXLINE( 482)					::lime::ui::Touch_obj::onEnd->dispatch(touch);
HXLINE( 484)					this->currentTouches->remove(this->touchEventInfo->id);
HXLINE( 485)					this->unusedTouchesPool->add(touch);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 489)				 ::lime::ui::Touch touch = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
HXLINE( 491)				if (::hx::IsNotNull( touch )) {
HXLINE( 493)					touch->x = this->touchEventInfo->x;
HXLINE( 494)					touch->y = this->touchEventInfo->y;
HXLINE( 495)					touch->dx = this->touchEventInfo->dx;
HXLINE( 496)					touch->dy = this->touchEventInfo->dy;
HXLINE( 497)					touch->pressure = this->touchEventInfo->pressure;
HXLINE( 499)					::lime::ui::Touch_obj::onMove->dispatch(touch);
            				}
            			}
            			break;
            			default:{
...
HXLINE( 607)				::Array< ::Dynamic> _g = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 607)				{
HXLINE( 607)					int _g1 = 0;
HXDLIN( 607)					::Array< ::Dynamic> _g2 = ::haxe::Timer_obj::sRunningTimers;
HXDLIN( 607)					while((_g1 < _g2->length)){
HXLINE( 607)						 ::haxe::Timer v = _g2->__get(_g1).StaticCast<  ::haxe::Timer >();
HXDLIN( 607)						_g1 = (_g1 + 1);
HXDLIN( 607)						if (::hx::IsNotNull( v )) {
HXLINE( 607)							_g->push(v);
            						}
            					}
            				}
HXDLIN( 607)				::haxe::Timer_obj::sRunningTimers = _g;
            			}
            		}

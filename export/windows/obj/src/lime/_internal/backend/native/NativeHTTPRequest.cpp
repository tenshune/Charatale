...
HXLINE( 397)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::haxe::io::Error_obj::OutsideBounds_dyn()));
            			}
...
HXLINE( 519)					 ::lime::net::curl::CURL curl = message->curl;
HXLINE( 520)					 ::Dynamic status = curl->getInfo(2097154);
HXLINE( 523)					::lime::_internal::backend::native::NativeHTTPRequest_obj::cookieList = ( (::Array< ::String >)(curl->getInfo(4194332)) );
HXLINE( 525)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->removeHandle(curl);
HXLINE( 526)					curl->cleanup();
...
HXLINE( 581)						 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 581)						instance1->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error,responseData));
            					}
            					else {
HXLINE( 585)						::String error = ( (::String)((HX_("Status ",8e,8c,bf,03) + state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic))) );
HXLINE( 586)						 ::haxe::io::Bytes responseData = instance->buildBuffer();
HXLINE( 587)						 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 587)						instance1->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error,responseData));
            					}
            				}
            			}
            			else {
HXLINE( 592)				::String error = ::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic)) ));
HXLINE( 593)				 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 593)				instance1->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error,null()));
            			}

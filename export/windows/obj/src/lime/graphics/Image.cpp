...
HXLINE(1082)				 ::Dynamic _hx_tmp =  ::Dynamic(this->buffer->_hx___srcBitmapData->__Field(HX_("merge",b8,a2,c6,05),::hx::paccDynamic));
HXDLIN(1082)				 ::Dynamic sourceImage1 = sourceImage->buffer->_hx___srcBitmapData;
HXDLIN(1082)				 ::Dynamic _hx_tmp1 = sourceRect->_hx___toFlashRectangle();
HXDLIN(1082)				_hx_tmp(sourceImage1,_hx_tmp1,destPoint->_hx___toFlashPoint(),redMultiplier,greenMultiplier,blueMultiplier,alphaMultiplier);
            			}
            			break;
            			default:{
HXLINE(1086)				return;
...
HXDLIN(1183)					int this1 = 0;
HXDLIN(1183)					int argb1 = this1;
...
HXDLIN(1182)						int argb1 = this1;
HXDLIN(1182)						argb1 = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1179)						argb = argb1;
...
HXDLIN(1220)					int this1 = 0;
HXDLIN(1220)					int argb1 = this1;
...
HXDLIN(1219)						int argb1 = this1;
HXDLIN(1219)						argb1 = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1216)						argb = argb1;
...
HXDLIN(1362)					int this1 = 0;
HXDLIN(1362)					int argb = this1;
...
HXDLIN(1361)						int this1 = 0;
HXDLIN(1361)						int argb = this1;
HXDLIN(1361)						argb = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1358)						_color = argb;
...
HXLINE(1369)					int rgba = mask;
HXDLIN(1369)					int this1 = 0;
HXDLIN(1369)					int argb = this1;
HXDLIN(1369)					argb = ((((((rgba & 255) & 255) << 24) | (((::hx::UShr(rgba,24) & 255) & 255) << 16)) | (((::hx::UShr(rgba,16) & 255) & 255) << 8)) | ((::hx::UShr(rgba,8) & 255) & 255));
HXLINE(1365)					_mask = argb;
            				}
            				else {
...
HXDLIN(1365)						goto _hx_goto_25;
            					...
            					if (  (_hx_switch_1==2) ){
HXLINE(1368)						int bgra = mask;
HXDLIN(1368)						int this1 = 0;
HXDLIN(1368)						int argb = this1;
HXDLIN(1368)						argb = ((((((bgra & 255) & 255) << 24) | (((::hx::UShr(bgra,8) & 255) & 255) << 16)) | (((::hx::UShr(bgra,16) & 255) & 255) << 8)) | ((::hx::UShr(bgra,24) & 255) & 255));
HXLINE(1365)						_mask = argb;
...
HXLINE(1375)				 ::Dynamic _hx_tmp =  ::Dynamic(this->buffer->_hx___srcBitmapData->__Field(HX_("threshold",ab,c3,a3,34),::hx::paccDynamic));
HXDLIN(1375)				 ::Dynamic _hx_tmp1 = sourceImage->buffer->get_src();
HXDLIN(1375)				 ::Dynamic _hx_tmp2 = sourceRect->_hx___toFlashRectangle();
HXDLIN(1375)				return ( (int)(_hx_tmp(_hx_tmp1,_hx_tmp2,destPoint->_hx___toFlashPoint(),operation,threshold,_color,_mask,copySource)) );
            			}
            			break;
            			default:{
            			}
...
HXDLIN(1398)			r1->height = (r1->height - -(r->y));
...
HXDLIN(1406)			r1->width = (r1->width - ((r->x + r->width) - ( (Float)(this->width) )));
HXLINE(1408)			if ((r->width <= 0)) {
HXLINE(1408)				return null();
            			}
            		}
HXLINE(1411)		if (((r->y + r->height) >= this->height)) {
HXLINE(1413)			 ::lime::math::Rectangle r1 = r;
HXDLIN(1413)			r1->height = (r1->height - ((r->y + r->height) - ( (Float)(this->height) )));
...
HXDLIN(1481)				 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1481)				_this->buffer = this2;
...
HXLINE(1481)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1481)					::cpp::VirtualArray array = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1481)					_this->byteOffset = 0;
HXDLIN(1481)					_this->length = array->get_length();
HXDLIN(1481)					_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1481)					 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN(1481)						int elementSize = _this->bytesPerElement;
HXDLIN(1481)						if ((view->type == _this->type)) {
HXLINE(1481)							int srcLength = srcData->length;
HXDLIN(1481)							int cloneLength = (srcLength - srcByteOffset);
HXDLIN(1481)							 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1481)							_this->buffer = this1;
HXDLIN(1481)							_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(1481)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            						}
HXDLIN(1481)						_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN(1481)						_this->byteOffset = 0;
HXDLIN(1481)						_this->length = srcLength;
HXDLIN(1481)						this1 = _this;
            					}
            					else {
...
HXLINE(1481)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            							}
HXDLIN(1481)							if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE(1481)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            							}
...
HXDLIN(1481)								if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE(1481)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
...
HXLINE(1481)								newByteLength = (( (int)(len) ) * _this->bytesPerElement);
HXDLIN(1481)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(1481)								if ((newRange > bufferByteLength)) {
HXLINE(1481)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
            							}
HXDLIN(1481)							_this->buffer = buffer;
HXDLIN(1481)							_this->byteOffset = in_byteOffset;
HXDLIN(1481)							_this->byteLength = newByteLength;
HXDLIN(1481)							_this->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this->bytesPerElement) )));
HXDLIN(1481)							this1 = _this;
            						}
            						else {
HXLINE(1481)							HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85)));
            						}
            					}
            				}
            			}
...
HXDLIN(1559)					 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1559)					_this->buffer = this2;
...
HXLINE(1559)						 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1559)						::cpp::VirtualArray array = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1559)						_this->byteOffset = 0;
HXDLIN(1559)						_this->length = array->get_length();
HXDLIN(1559)						_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1559)						 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN(1559)							int elementSize = _this->bytesPerElement;
HXDLIN(1559)							if ((view->type == _this->type)) {
HXLINE(1559)								int srcLength = srcData->length;
HXDLIN(1559)								int cloneLength = (srcLength - srcByteOffset);
HXDLIN(1559)								 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1559)								_this->buffer = this1;
HXDLIN(1559)								_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1559)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            							}
HXDLIN(1559)							_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN(1559)							_this->byteOffset = 0;
HXDLIN(1559)							_this->length = srcLength;
HXDLIN(1559)							this1 = _this;
            						}
            						else {
...
HXLINE(1559)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
HXDLIN(1559)								if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE(1559)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
...
HXDLIN(1559)									if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE(1559)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
...
HXLINE(1559)									newByteLength = (( (int)(len) ) * _this->bytesPerElement);
HXDLIN(1559)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1559)									if ((newRange > bufferByteLength)) {
HXLINE(1559)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
            								}
HXDLIN(1559)								_this->buffer = buffer2;
HXDLIN(1559)								_this->byteOffset = in_byteOffset;
HXDLIN(1559)								_this->byteLength = newByteLength;
HXDLIN(1559)								_this->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this->bytesPerElement) )));
HXDLIN(1559)								this1 = _this;
            							}
            							else {
HXLINE(1559)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85)));
            							}
            						}
            					}
            				}
...
HXLINE(1795)				_hx_tmp = this->buffer->premultiplied;
            			}
            			else {

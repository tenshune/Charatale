...
HXDLIN( 175)					 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 175)					_this->buffer = this2;
...
HXLINE( 175)						 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN( 175)						::cpp::VirtualArray array = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 175)						_this->byteOffset = 0;
HXDLIN( 175)						_this->length = array->get_length();
HXDLIN( 175)						_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN( 175)						 ::haxe::io::Bytes this2 = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
...
HXDLIN( 175)							if ((view->type == _this->type)) {
HXLINE( 175)								int srcLength = srcData->length;
HXDLIN( 175)								int cloneLength = (srcLength - srcByteOffset);
HXDLIN( 175)								 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 175)								_this->buffer = this1;
HXDLIN( 175)								_this->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE( 175)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("unimplemented",09,2f,74,b4)));
            							}
HXDLIN( 175)							_this->byteLength = (_this->bytesPerElement * srcLength);
HXDLIN( 175)							_this->byteOffset = 0;
HXDLIN( 175)							_this->length = srcLength;
HXDLIN( 175)							this1 = _this;
            						}
            						else {
...
HXLINE( 175)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
HXDLIN( 175)								if ((::hx::Mod(in_byteOffset,_this->bytesPerElement) != 0)) {
HXLINE( 175)									HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            								}
...
HXDLIN( 175)									if ((::hx::Mod(bufferByteLength,_this->bytesPerElement) != 0)) {
HXLINE( 175)										HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::lime::utils::TAError_obj::RangeError_dyn()));
            									}
...
HXLINE( 175)								HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85)));
            							}
            						}
            					}
            				}

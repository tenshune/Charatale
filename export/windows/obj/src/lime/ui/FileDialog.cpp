...
HXLINE( 185)					path1 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title,filter,defaultPath);
HXLINE( 189)					worker->sendComplete(( ( ::Dynamic)(path1) ));
            				}
            				break;
            				case (int)3: {
HXLINE( 156)					 ::hx::Object * path2 = ::hx::DynamicPtr(null());
HXLINE( 165)					path2 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_directory(title,filter,defaultPath);

...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_26___update,"lime.system.Clipboard","__update",0x48c84c67,"lime.system.Clipboard.__update","lime/system/Clipboard.hx",26,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_56_get_text,"lime.system.Clipboard","get_text",0xe647e374,"lime.system.Clipboard.get_text","lime/system/Clipboard.hx",56,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_87_set_text,"lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",87,0x9490b5ee)
...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_23_boot,"lime.system.Clipboard","boot",0x8554e870,"lime.system.Clipboard.boot","lime/system/Clipboard.hx",23,0x9490b5ee)
namespace lime{
...
void Clipboard_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_26___update)
HXLINE(  27)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  28)		::lime::_hx_system::Clipboard_obj::_text = null();
HXLINE(  38)		::lime::_hx_system::Clipboard_obj::_text = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_get_text()) );
HXLINE(  46)		::lime::_hx_system::Clipboard_obj::_hx___updated = true;
...
::String Clipboard_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_56_get_text)
HXLINE(  74)		if (!(::lime::_hx_system::Clipboard_obj::_hx___updated)) {
HXLINE(  79)			::lime::_hx_system::Clipboard_obj::_hx___update();
            		}
HXLINE(  83)		return ::lime::_hx_system::Clipboard_obj::_text;
            	}
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_87_set_text)
HXLINE(  88)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  89)		::lime::_hx_system::Clipboard_obj::_text = value;
HXLINE(  92)		::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_set_text(value);
HXLINE( 103)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE( 105)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
...
{
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_23_boot)
HXDLIN(  23)		_hx___updated = false;
            	}
}

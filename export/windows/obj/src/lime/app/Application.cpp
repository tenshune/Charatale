...
HXLINE( 573)			_g(gamepad1,axis,value);
            		}
...
HXLINE( 574)			_g1(gamepad2,button);
            		}
...
HXLINE( 575)			_g2(gamepad3,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 574)		 ::Dynamic _g1 = this->onGamepadButtonDown_dyn();
...
HXLINE( 575)		 ::Dynamic _g2 = this->onGamepadButtonUp_dyn();
...
HXLINE( 576)		 ::Dynamic _g3 = this->onGamepadDisconnect_dyn();
...
HXLINE( 583)			_g(joystick1,axis,value);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE( 584)			_g1(joystick2,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 585)			_g2(joystick3,button);
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 587)			_g4(joystick5,hat,position);
            		}
            		HX_END_LOCAL_FUNC2((void))
...
HXLINE( 584)		 ::Dynamic _g1 = this->onJoystickButtonDown_dyn();
...
HXLINE( 585)		 ::Dynamic _g2 = this->onJoystickButtonUp_dyn();
...
HXLINE( 586)		 ::Dynamic _g3 = this->onJoystickDisconnect_dyn();
...
HXLINE( 587)		 ::Dynamic _g4 = this->onJoystickHatMove_dyn();
...
HXLINE( 588)		 ::Dynamic _g5 = this->onJoystickTrackballMove_dyn();
